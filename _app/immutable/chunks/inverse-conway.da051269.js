import{S as ba,i as ga,s as ka,k as o,q as l,a as p,l as s,m as r,r as h,h as t,c as u,n as c,b as i,E as a,G as Ht}from"./index.7ee8938c.js";const Ea="png",_a=1200,Aa=600,Pa="srgb",Ta=4,Ca="uchar",Sa=72,xa=!1,Ia=!1,qa=!0,Ma=void 0,Wa=!0,Va=!1,Oa=""+new URL("../assets/inverse-conway.18de8b3a.png",import.meta.url).href,Ba={format:Ea,width:_a,height:Aa,space:Pa,channels:Ta,depth:Ca,density:Sa,isProgressive:xa,hasProfile:Ia,hasAlpha:qa,aspect:Ma,withoutEnlargement:Wa,withoutReduction:Va,src:Oa};function Na(va){let f,Ue,pe,w,y,Y,Ge,ue,d,je,Z,Fe,Je,q,Ke,Qe,ee,$e,De,de,M,te,Xe,me,W,Ye,fe,v,b,ae,Ze,we,V,et,ye,g,tt,ne,at,nt,ve,O,it,be,B,ot,ge,N,st,ke,k,E,ie,rt,Ee,H,lt,_e,L,ht,Ae,m,ct,oe,pt,ut,se,dt,mt,Pe,z,ft,Te,_,A,re,wt,Ce,R,yt,Se,U,vt,xe,G,bt,Ie,P,T,le,gt,qe,j,kt,Me,F,Et,We,J,_t,Ve,K,At,Oe,Q,Pt,Be,C,Tt,he,Ct,St,Ne,S,x,ce,xt,He,$,It,Le,D,qt;return{c(){f=o("p"),Ue=l(`Today we’re going to be looking at an often forgotten topic: the interdependency
between the software architecture and an organisation structure; and how to use
that to one’s advantage.`),pe=p(),w=o("h2"),y=o("a"),Y=o("span"),Ge=l("Who is Conway?"),ue=p(),d=o("p"),je=l(`There are two luminary people in software engineering named Conway who are often
mistakenly thought to be the same person. One is a british mathematician `),Z=o("em"),Fe=l("John"),Je=l(`
...
the way of getting the work done.`),xe=p(),G=o("p"),bt=l(`In non-trivial cases architecture always follows the organisational structure,
...
Which is essentially the same problem structurally.`),Me=p(),F=o("p"),Et=l(`The way it normally goes is that a company hires some sort of a Very Smart
...
between the software architecture and an organisation structure; and how to use
that to one’s advantage.`),n.forEach(t),pe=u(e),w=s(e,"H2",{id:!0});var Mt=r(w);y=s(Mt,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Lt=r(y);Y=s(Lt,"SPAN",{class:!0}),r(Y).forEach(t),Lt.forEach(t),Ge=h(Mt,"Who is Conway?"),Mt.forEach(t),ue=u(e),d=s(e,"P",{});var I=r(d);je=h(I,`There are two luminary people in software engineering named Conway who are often
mistakenly thought to be the same person. One is a british mathematician `),Z=s(I,"EM",{});var zt=r(Z);Fe=h(zt,"John"),zt.forEach(t),Je=h(I,`
Conway famous for creating the
...
following idea:`),I.forEach(t),de=u(e),M=s(e,"BLOCKQUOTE",{});var Gt=r(M);te=s(Gt,"P",{});var jt=r(te);Xe=h(jt,`Organizations, who design systems, are constrained to produce designs which
are copies of the communication structures of these organizations`),jt.forEach(t),Gt.forEach(t),me=u(e),W=s(e,"P",{});var Ft=r(W);Ye=h(Ft,"Which eventually became known as the Conway’s law."),Ft.forEach(t),fe=u(e),v=s(e,"H2",{id:!0});var Wt=r(v);b=s(Wt,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Jt=r(b);ae=s(Jt,"SPAN",{class:!0}),r(ae).forEach(t),Jt.forEach(t),Ze=h(Wt,"The Conway’s law"),Wt.forEach(t),we=u(e),V=s(e,"P",{});var Kt=r(V);et=h(Kt,`What the Conway’s law describes is the interdependency between an application
architecture and an organisational structure. Which is an important factor to
...
since we don’t know what the product will really look like after it meets the
markets, that predefined architecture will sooner or later will start getting in
the way of getting the work done.`),sa.forEach(t),xe=u(e),G=s(e,"P",{});var ra=r(G);bt=h(ra,`In non-trivial cases architecture always follows the organisational structure,
and the organisational structure can be purposefully attached to the business
structure. And that structure will eventually put technology in the most
...
case is more common that a rework of a legacy application. Most startups produce
monoliths as an MVP and then need to rework and scale their initial application.
Which is essentially the same problem structurally.`),ha.forEach(t),Me=u(e),F=s(e,"P",{});var ca=r(F);Et=h(ca,`The way it normally goes is that a company hires some sort of a Very Smart
Person that will dive into the old monolith and produce a proposed microservices
based architecture. Then that new architecture is handed down to the original
