import{S as Sl,i as xl,s as Gl,k as s,q as o,a as m,l as n,m as r,r as a,h as i,c as f,H as me,n as u,b as h,F as t,C as Nn}from"./index-920be987.js";const Nl="png",Rl=1200,Dl=600,Cl="srgb",Bl=3,Fl="uchar",Wl=132,Ul=!1,Ll="inch",jl=!1,Ml=!1,Hl=1,Yl=void 0,ql=!1,Jl=!1,Ql=""+new URL("../assets/estimations-probability-957646fe.png",import.meta.url).href,$l={format:Nl,width:Rl,height:Dl,space:Cl,channels:Bl,depth:Fl,density:Wl,isProgressive:Ul,resolutionUnit:Ll,hasProfile:jl,hasAlpha:Ml,orientation:Hl,aspect:Yl,withoutEnlargement:ql,withoutReduction:Jl,src:Ql},zl=""+new URL("../assets/agile-4ce2fe1d.webp",import.meta.url).href,Kl=""+new URL("../assets/normal-distribution-a2f6577f.png",import.meta.url).href,Vl=""+new URL("../assets/asymmetric-distribution-004e8694.webp",import.meta.url).href,Xl=""+new URL("../assets/bimodal-distribution-029055e7.png",import.meta.url).href,Zl=""+new URL("../assets/estimations-probability-6e82d67a.webp",import.meta.url).href,eh=""+new URL("../assets/accuracy-precision-fb1d55cd.png",import.meta.url).href,th=""+new URL("../assets/accuracy-precision-2-220000ab.png",import.meta.url).href,ih=""+new URL("../assets/we-ask-for-estimations-5f759b68.webp",import.meta.url).href;function oh(Ol){let G,wo,di,N,fe,Rn,$e,Eo,pi,ce,ko,yi,R,D,ze,_o,bi,de,Ao,vi,pe,Io,gi,A,Ke,d,Ve,To,Po,Xe,Oo,So,Ze,xo,Go,et,No,Ro,tt,Do,Co,it,Bo,Fo,Wo,ot,p,at,Uo,Lo,st,jo,Mo,nt,Ho,Yo,rt,qo,Jo,lt,Qo,$o,ht,zo,Ko,Vo,ut,c,mt,Xo,Zo,ft,ea,ta,ct,ia,oa,dt,aa,sa,pt,na,ra,yt,la,ha,bt,ua,ma,vt,fa,wi,C,B,gt,ca,Ei,ye,da,ki,F,be,Dn,wt,pa,_i,k,ya,Et,ba,va,kt,ga,wa,_t,Ea,ka,Ai,ve,_a,Ii,W,ge,Cn,At,Aa,Ti,v,Ia,It,Ta,Pa,Tt,Oa,Sa,Pt,xa,Ga,Ot,Na,Ra,Pi,we,Da,Oi,U,Ee,Bn,St,Ca,Si,ke,Ba,xi,L,j,xt,Fa,Gi,_e,Wa,Ni,M,Ae,Fn,Gt,Ua,Ri,Ie,La,Di,Te,ja,Ci,I,H,Nt,Ma,Rt,Ha,Ya,Bi,Y,qa,Dt,Ja,Qa,Fi,q,$a,Ct,za,Ka,Wi,y,Va,Bt,Xa,Za,Ft,es,ts,Wt,is,os,Ut,as,ss,Lt,ns,rs,Ui,Pe,ls,Li,J,Q,jt,hs,ji,Oe,us,Mi,$,z,Mt,ms,fs,Ht,cs,ds,ps,K,Yt,ys,bs,qt,vs,gs,Hi,V,Se,Wn,Jt,ws,Yi,xe,Es,qi,X,Ge,Un,Qt,ks,Ji,g,_s,$t,As,Is,zt,Ts,Ps,Kt,Os,Ss,Vt,xs,Gs,Qi,Ne,Ns,$i,T,Rs,Xt,Ds,Cs,Zt,Bs,Fs,zi,Z,ee,ei,Ws,Ki,P,Us,ti,Ls,js,ii,Ms,Hs,Vi,Re,Ys,Xi,te,De,Ln,oi,qs,Zi,ie,oe,ai,Js,eo,Ce,Qs,to,ae,$s,si,zs,Ks,io,Be,Vs,oo,Fe,Xs,ao,se,ne,ni,Zs,so,We,en,no,re,tn,ri,on,an,ro,O,sn,li,nn,rn,hi,ln,hn,lo,Ue,un,ho,Le,mn,uo,le,he,ui,fn,mo,je,cn,fo,Me,dn,co,He,pn;return{c(){G=s("p"),wo=o(`I’ve been through a fair bit of teams; and I have built and managed my own share
