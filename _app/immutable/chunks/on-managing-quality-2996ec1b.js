import{S as no,i as lo,s as ro,k as s,q as r,a as h,l as n,m as l,r as u,h as t,c,n as p,H as Nt,b as o,F as i,C as na}from"./index-920be987.js";const uo="png",ho=1200,co=600,po="srgb",fo=4,mo="uchar",yo=72,wo=!1,vo=!1,bo=!0,go=void 0,qo=!0,ko=!1,_o=""+new URL("../assets/quality-management-ce635ca6.png",import.meta.url).href,Eo={format:uo,width:ho,height:co,space:po,channels:fo,depth:mo,density:yo,isProgressive:wo,hasProfile:vo,hasAlpha:bo,aspect:go,withoutEnlargement:qo,withoutReduction:ko,src:_o},xo=""+new URL("../assets/cost-of-good-quality-65540dcf.webp",import.meta.url).href,To=""+new URL("../assets/cost-of-poor-quality-028e768d.png",import.meta.url).href,Io=""+new URL("../assets/cost-vs-quality-62ce6424.webp",import.meta.url).href,Po=""+new URL("../assets/cost-vs-quality-2-e385aaf9.png",import.meta.url).href;function Ao(so){let d,Mt,Re,O,Wt,je,m,y,ge,Lt,Ue,H,Ot,Qe,R,Ht,De,j,Rt,ze,U,qe,jt,Ve,w,Ut,ke,Qt,Dt,Je,v,b,_e,zt,Ze,Q,Vt,Ke,M,Ee,Jt,Zt,$e,g,D,la,xe,Kt,Xe,W,Te,$t,Xt,Ye,q,z,ra,Ie,Yt,et,V,ei,tt,k,J,ua,Pe,ti,it,Z,ii,at,_,E,Ae,ai,ot,x,oi,Se,si,ni,st,K,li,nt,T,$,ha,Ce,ri,lt,X,ui,rt,Y,hi,ut,ee,ci,ht,I,P,Fe,pi,ct,te,fi,pt,f,ie,Ge,di,mi,yi,ae,Be,wi,vi,bi,oe,Ne,gi,qi,ft,se,ki,dt,A,S,Me,_i,mt,ne,Ei,yt,C,We,xi,Ti,L,Ii,Le,Pi,Ai,wt,le,Si,vt,re,Ci,bt,ue,Fi,gt,he,Gi,qt,F,G,Oe,Bi,kt,ce,Ni,_t,pe,Mi,Et,fe,Wi,xt,de,Li,Tt,me,Oi,It,B,N,He,Hi,Pt,ye,Ri,At,we,ji,St,ve,Ui;return{c(){d=s("p"),Mt=r(`The quality of software engineering is a bit of a beaten up topic. But,
...
framework:`),Ke=h(),M=s("p"),Ee=s("strong"),Jt=r("The cost of great quality"),Zt=r(` - defines the amount of investments necessary to
...
For example, a car should have four fully inflated wheels and an engine.`),yi=h(),ae=s("li"),Be=s("code"),wi=r("Required features"),vi=r(` - those are the features that people usually use to
...
if the visual blings in an app stopped working for a day or two.`),dt=h(),A=s("h2"),S=s("a"),Me=s("span"),_i=r("In practice"),mt=h(),ne=s("p"),Ei=r("So, lets quickly recap what we have gathered so far. There are two main ideas:"),yt=h(),C=s("ol"),We=s("li"),xi=r(`In a software product company the cost of poor quality grossly outweighs the
...
security is limited by the security vendor’s guarantees.`),qt=h(),F=s("h2"),G=s("a"),Oe=s("span"),Bi=r("Funding the quality"),kt=h(),ce=s("p"),Ni=r(`Spare some behemoth companies like Apple, Google, or Samsung that can invest in
...
they can spend on quality.`),_t=h(),pe=s("p"),Mi=r(`Still, even best practice level product development costs money. And so, often
...
ultimately succeed have the quality baked in as a default`),It=h(),B=s("h2"),N=s("a"),He=s("span"),Hi=r("Wrapping up"),Pt=h(),ye=s("p"),Ri=r(`There is actual science behind this madness. And if you’re interested in the
...
unnoticed.`),this.h()},l(e){d=n(e,"P",{});var a=l(d);Mt=u(a,`The quality of software engineering is a bit of a beaten up topic. But,
unfortunately, these conversations spend much of the time talking about
technical debt and why it’s, well, bad. While that’s not wrong, the subject of
quality is bit more complex than that, and today I wanted to share what I have
...
framework:`),ga.forEach(t),Ke=c(e),M=n(e,"P",{});var zi=l(M);Ee=n(zi,"STRONG",{});var qa=l(Ee);Jt=u(qa,"The cost of great quality"),qa.forEach(t),Zt=u(zi,` - defines the amount of investments necessary to
bring quality higher. Just as intuition tells us, the higher the quality the
higher the cost. But, it’s not a linear relationship, it’s an exponential one.
As in the initial investments buy more quality, but eventually quality stops
...
an additional copy, aka margin cost, is virtually zero, it’s easy to understand
that the gap between the cost of good quality and the cost of the poor quality
will be exceptionally large.`),Ga.forEach(t),ut=c(e),ee=n(e,"P",{});var Ba=l(ee);ci=u(Ba,`Which means that in a well functioning software engineering company there is no
really compromise to make or balance to find. The company should invest in as
much quality as it can afford, because the cost of poor quality grossly
outweighs the cost of good quality.`),Ba.forEach(t),ht=c(e),I=n(e,"H2",{id:!0});var Yi=l(I);P=n(Yi,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Na=l(P);Fe=n(Na,"SPAN",{class:!0}),l(Fe).forEach(t),Na.forEach(t),pi=u(Yi,"Another dimension"),Yi.forEach(t),ct=c(e),te=n(e,"P",{});var Ma=l(te);fi=u(Ma,`There is yet another dimension to this problem as well. Because quality in
products in not an uniformly distributed entity and actually has a deeper
structure. Virtually any set of features that a product has could be divided
into three categories:`),Ma.forEach(t),pt=c(e),f=n(e,"OL",{});var be=l(f);ie=n(be,"LI",{});var ea=l(ie);Ge=n(ea,"CODE",{});var Wa=l(Ge);di=u(Wa,"Baseline expectations"),Wa.forEach(t),mi=u(ea,` - people don’t even think about those as features.
For example, a car should have four fully inflated wheels and an engine.`),ea.forEach(t),yi=c(be),ae=n(be,"LI",{});var ta=l(ae);Be=n(ta,"CODE",{});var La=l(Be);wi=u(La,"Required features"),La.forEach(t),vi=u(ta,` - those are the features that people usually use to
describe a product. For example, a car should be quiet on the inside, and it
should have a good infotainment system, and it should be comfortable for a
...
be unavailable due to a new deployment or a production bug. And delighters are
expected to mostly work, but if they don’t it won’t affect the users much: say
if the visual blings in an app stopped working for a day or two.`),Ha.forEach(t),dt=c(e),A=n(e,"H2",{id:!0});var aa=l(A);S=n(aa,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Ra=l(S);Me=n(Ra,"SPAN",{class:!0}),l(Me).forEach(t),Ra.forEach(t),_i=u(aa,"In practice"),aa.forEach(t),mt=c(e),ne=n(e,"P",{});var ja=l(ne);Ei=u(ja,"So, lets quickly recap what we have gathered so far. There are two main ideas:"),ja.forEach(t),yt=c(e),C=n(e,"OL",{});var Gt=l(C);We=n(Gt,"LI",{});var Ua=l(We);xi=u(Ua,`In a software product company the cost of poor quality grossly outweighs the
cost of good quality.`),Ua.forEach(t),Ti=c(Gt),L=n(Gt,"LI",{});var Bt=l(L);Ii=u(Bt,`The internal structure of product quality dictates that the baseline features
must have great quality as a default expectation, and required features
should follow close behind. Meaning that 95+% of any application’s features
are `),Le=n(Bt,"EM",{});var Qa=l(Le);Pi=u(Qa,"expected"),Qa.forEach(t),Ai=u(Bt," to have great quality."),Bt.forEach(t),Gt.forEach(t),wt=c(e),le=n(e,"P",{});var Da=l(le);Si=u(Da,`Both of those ideas point in the same direction, that investing in quality as
much as possible is the most sensible approach. Zero technical debt is the way
...
is not there, the company will instantly loose most of it’s customers to a
competitor that can make the same thing 10% better. Hence the products that
ultimately succeed have the quality baked in as a default`),eo.forEach(t),It=c(e),B=n(e,"H2",{id:!0});var sa=l(B);N=n(sa,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var to=l(N);He=n(to,"SPAN",{class:!0}),l(He).forEach(t),to.forEach(t),Hi=u(sa,"Wrapping up"),sa.forEach(t),Pt=c(e),ye=n(e,"P",{});var io=l(ye);Ri=u(io,`There is actual science behind this madness. And if you’re interested in the
actual statistical analysis and quantifiable methodology, I would strongly
recommend diving into lean six-sigma. It’s not entirely software engineering,
...
because the company leadership never bothered to count the cost of poor quality,
and the expenses that go into maintaining poor quality applications largely go
unnoticed.`),oo.forEach(t),this.h()},h(){p(ge,"class","icon icon-link"),p(y,"aria-hidden","true"),p(y,"tabindex","-1"),p(y,"href","#the-intuition"),p(m,"id","the-intuition"),p(_e,"class","icon icon-link"),p(b,"aria-hidden","true"),p(b,"tabindex","-1"),p(b,"href","#the-cost-of-quality"),p(v,"id","the-cost-of-quality"),Nt(D.src,la=xo)||p(D,"src",la),p(D,"alt","Cost of great quality"),p(g,"class","rehype-figure"),Nt(z.src,ra=To)||p(z,"src",ra),p(z,"alt","Cost of poor quality"),p(q,"class","rehype-figure"),Nt(J.src,ua=Io)||p(J,"src",ua),p(J,"alt","Cost vs. quality"),p(k,"class","rehype-figure"),p(Ae,"class","icon icon-link"),p(E,"aria-hidden","true"),p(E,"tabindex","-1"),p(E,"href","#the-problem"),p(_,"id","the-problem"),Nt($.src,ha=Po)||p($,"src",ha),p($,"alt","Cost vs. quality in reality"),p(T,"class","rehype-figure"),p(Fe,"class","icon icon-link"),p(P,"aria-hidden","true"),p(P,"tabindex","-1"),p(P,"href","#another-dimension"),p(I,"id","another-dimension"),p(Me,"class","icon icon-link"),p(S,"aria-hidden","true"),p(S,"tabindex","-1"),p(S,"href","#in-practice"),p(A,"id","in-practice"),p(Oe,"class","icon icon-link"),p(G,"aria-hidden","true"),p(G,"tabindex","-1"),p(G,"href","#funding-the-quality"),p(F,"id","funding-the-quality"),p(He,"class","icon icon-link"),p(N,"aria-hidden","true"),p(N,"tabindex","-1"),p(N,"href","#wrapping-up"),p(B,"id","wrapping-up")},m(e,a){o(e,d,a),i(d,Mt),o(e,Re,a),o(e,O,a),i(O,Wt),o(e,je,a),o(e,m,a),i(m,y),i(y,ge),i(m,Lt),o(e,Ue,a),o(e,H,a),i(H,Ot),o(e,Qe,a),o(e,R,a),i(R,Ht),o(e,De,a),o(e,j,a),i(j,Rt),o(e,ze,a),o(e,U,a),i(U,qe),i(qe,jt),o(e,Ve,a),o(e,w,a),i(w,Ut),i(w,ke),i(ke,Qt),i(w,Dt),o(e,Je,a),o(e,v,a),i(v,b),i(b,_e),i(v,zt),o(e,Ze,a),o(e,Q,a),i(Q,Vt),o(e,Ke,a),o(e,M,a),i(M,Ee),i(Ee,Jt),i(M,Zt),o(e,$e,a),o(e,g,a),i(g,D),i(g,xe),i(xe,Kt),o(e,Xe,a),o(e,W,a),i(W,Te),i(Te,$t),i(W,Xt),o(e,Ye,a),o(e,q,a),i(q,z),i(q,Ie),i(Ie,Yt),o(e,et,a),o(e,V,a),i(V,ei),o(e,tt,a),o(e,k,a),i(k,J),i(k,Pe),i(Pe,ti),o(e,it,a),o(e,Z,a),i(Z,ii),o(e,at,a),o(e,_,a),i(_,E),i(E,Ae),i(_,ai),o(e,ot,a),o(e,x,a),i(x,oi),i(x,Se),i(Se,si),i(x,ni),o(e,st,a),o(e,K,a),i(K,li),o(e,nt,a),o(e,T,a),i(T,$),i(T,Ce),i(Ce,ri),o(e,lt,a),o(e,X,a),i(X,ui),o(e,rt,a),o(e,Y,a),i(Y,hi),o(e,ut,a),o(e,ee,a),i(ee,ci),o(e,ht,a),o(e,I,a),i(I,P),i(P,Fe),i(I,pi),o(e,ct,a),o(e,te,a),i(te,fi),o(e,pt,a),o(e,f,a),i(f,ie),i(ie,Ge),i(Ge,di),i(ie,mi),i(f,yi),i(f,ae),i(ae,Be),i(Be,wi),i(ae,vi),i(f,bi),i(f,oe),i(oe,Ne),i(Ne,gi),i(oe,qi),o(e,ft,a),o(e,se,a),i(se,ki),o(e,dt,a),o(e,A,a),i(A,S),i(S,Me),i(A,_i),o(e,mt,a),o(e,ne,a),i(ne,Ei),o(e,yt,a),o(e,C,a),i(C,We),i(We,xi),i(C,Ti),i(C,L),i(L,Ii),i(L,Le),i(Le,Pi),i(L,Ai),o(e,wt,a),o(e,le,a),i(le,Si),o(e,vt,a),o(e,re,a),i(re,Ci),o(e,bt,a),o(e,ue,a),i(ue,Fi),o(e,gt,a),o(e,he,a),i(he,Gi),o(e,qt,a),o(e,F,a),i(F,G),i(G,Oe),i(F,Bi),o(e,kt,a),o(e,ce,a),i(ce,Ni),o(e,_t,a),o(e,pe,a),i(pe,Mi),o(e,Et,a),o(e,fe,a),i(fe,Wi),o(e,xt,a),o(e,de,a),i(de,Li),o(e,Tt,a),o(e,me,a),i(me,Oi),o(e,It,a),o(e,B,a),i(B,N),i(N,He),i(B,Hi),o(e,Pt,a),o(e,ye,a),i(ye,Ri),o(e,At,a),o(e,we,a),i(we,ji),o(e,St,a),o(e,ve,a),i(ve,Ui)},p:na,i:na,o:na,d(e){e&&t(d),e&&t(Re),e&&t(O),e&&t(je),e&&t(m),e&&t(Ue),e&&t(H),e&&t(Qe),e&&t(R),e&&t(De),e&&t(j),e&&t(ze),e&&t(U),e&&t(Ve),e&&t(w),e&&t(Je),e&&t(v),e&&t(Ze),e&&t(Q),e&&t(Ke),e&&t(M),e&&t($e),e&&t(g),e&&t(Xe),e&&t(W),e&&t(Ye),e&&t(q),e&&t(et),e&&t(V),e&&t(tt),e&&t(k),e&&t(it),e&&t(Z),e&&t(at),e&&t(_),e&&t(ot),e&&t(x),e&&t(st),e&&t(K),e&&t(nt),e&&t(T),e&&t(lt),e&&t(X),e&&t(rt),e&&t(Y),e&&t(ut),e&&t(ee),e&&t(ht),e&&t(I),e&&t(ct),e&&t(te),e&&t(pt),e&&t(f),e&&t(ft),e&&t(se),e&&t(dt),e&&t(A),e&&t(mt),e&&t(ne),e&&t(yt),e&&t(C),e&&t(wt),e&&t(le),e&&t(vt),e&&t(re),e&&t(bt),e&&t(ue),e&&t(gt),e&&t(he),e&&t(qt),e&&t(F),e&&t(kt),e&&t(ce),e&&t(_t),e&&t(pe),e&&t(Et),e&&t(fe),e&&t(xt),e&&t(de),e&&t(Tt),e&&t(me),e&&t(It),e&&t(B),e&&t(Pt),e&&t(ye),e&&t(At),e&&t(we),e&&t(St),e&&t(ve)}}}const Co={slug:"i9Npg",title:"Beyond technical debt",description:"A deep dive into quality management structure",thumbnail:Eo,tags:["leadership","management","strategy"],medium:{tags:["Technical leadership","Technical strategy","Product management","Leadership","Strategy"]}};class Fo extends no{constructor(d){super(),lo(this,d,null,Ao,ro,{})}}export{Fo as default,Co as metadata};
