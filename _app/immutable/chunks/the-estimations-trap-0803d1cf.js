import{S as Sl,i as xl,s as Gl,k as s,q as o,a as m,l as n,m as r,r as a,h as i,c as f,H as me,n as u,b as h,F as t,C as Nn}from"./index-920be987.js";const Nl="png",Rl=1200,Dl=600,Cl="srgb",Wl=3,Bl="uchar",Fl=132,Ul=!1,Ll="inch",jl=!1,Ml=!1,Hl=1,Yl=void 0,ql=!1,Jl=!1,Ql=""+new URL("../assets/estimations-probability-957646fe.png",import.meta.url).href,$l={format:Nl,width:Rl,height:Dl,space:Cl,channels:Wl,depth:Bl,density:Fl,isProgressive:Ul,resolutionUnit:Ll,hasProfile:jl,hasAlpha:Ml,orientation:Hl,aspect:Yl,withoutEnlargement:ql,withoutReduction:Jl,src:Ql},zl=""+new URL("../assets/agile-424a54bd.jpg",import.meta.url).href,Kl=""+new URL("../assets/normal-distribution-c26de66a.webp",import.meta.url).href,Vl=""+new URL("../assets/asymmetric-distribution-3e45e0d6.webp",import.meta.url).href,Xl=""+new URL("../assets/bimodal-distribution-327cb732.webp",import.meta.url).href,Zl=""+new URL("../assets/estimations-probability-0f85d828.webp",import.meta.url).href,eh=""+new URL("../assets/accuracy-precision-ac084897.webp",import.meta.url).href,th=""+new URL("../assets/accuracy-precision-2-3f1d5f3a.webp",import.meta.url).href,ih=""+new URL("../assets/we-ask-for-estimations-418e9c10.jpeg",import.meta.url).href;function oh(Ol){let G,go,di,N,fe,Rn,$e,Eo,pi,ce,ko,yi,R,D,ze,_o,bi,de,Ao,vi,pe,Io,wi,A,Ke,d,Ve,To,Po,Xe,Oo,So,Ze,xo,Go,et,No,Ro,tt,Do,Co,it,Wo,Bo,Fo,ot,p,at,Uo,Lo,st,jo,Mo,nt,Ho,Yo,rt,qo,Jo,lt,Qo,$o,ht,zo,Ko,Vo,ut,c,mt,Xo,Zo,ft,ea,ta,ct,ia,oa,dt,aa,sa,pt,na,ra,yt,la,ha,bt,ua,ma,vt,fa,gi,C,W,wt,ca,Ei,ye,da,ki,B,be,Dn,gt,pa,_i,k,ya,Et,ba,va,kt,wa,ga,_t,Ea,ka,Ai,ve,_a,Ii,F,we,Cn,At,Aa,Ti,v,Ia,It,Ta,Pa,Tt,Oa,Sa,Pt,xa,Ga,Ot,Na,Ra,Pi,ge,Da,Oi,U,Ee,Wn,St,Ca,Si,ke,Wa,xi,L,j,xt,Ba,Gi,_e,Fa,Ni,M,Ae,Bn,Gt,Ua,Ri,Ie,La,Di,Te,ja,Ci,I,H,Nt,Ma,Rt,Ha,Ya,Wi,Y,qa,Dt,Ja,Qa,Bi,q,$a,Ct,za,Ka,Fi,y,Va,Wt,Xa,Za,Bt,es,ts,Ft,is,os,Ut,as,ss,Lt,ns,rs,Ui,Pe,ls,Li,J,Q,jt,hs,ji,Oe,us,Mi,$,z,Mt,ms,fs,Ht,cs,ds,ps,K,Yt,ys,bs,qt,vs,ws,Hi,V,Se,Fn,Jt,gs,Yi,xe,Es,qi,X,Ge,Un,Qt,ks,Ji,w,_s,$t,As,Is,zt,Ts,Ps,Kt,Os,Ss,Vt,xs,Gs,Qi,Ne,Ns,$i,T,Rs,Xt,Ds,Cs,Zt,Ws,Bs,zi,Z,ee,ei,Fs,Ki,P,Us,ti,Ls,js,ii,Ms,Hs,Vi,Re,Ys,Xi,te,De,Ln,oi,qs,Zi,ie,oe,ai,Js,eo,Ce,Qs,to,ae,$s,si,zs,Ks,io,We,Vs,oo,Be,Xs,ao,se,ne,ni,Zs,so,Fe,en,no,re,tn,ri,on,an,ro,O,sn,li,nn,rn,hi,ln,hn,lo,Ue,un,ho,Le,mn,uo,le,he,ui,fn,mo,je,cn,fo,Me,dn,co,He,pn;return{c(){G=s("p"),go=o(`I’ve been through a fair bit of teams; and I have built and managed my own share
...
find it useful.`),vi=m(),pe=s("p"),Io=o("Lets start with basic stats terminology:"),wi=m(),A=s("ul"),Ke=s("li"),d=s("p"),Ve=s("code"),To=o("average"),Po=o(", or "),Xe=s("code"),Oo=o("mean"),So=o(` for those in the US - means what you think it means. A
sum of the elements divided by the number of elements. The average of `),Ze=s("code"),xo=o("1,2,3"),Go=o(`
is `),et=s("code"),No=o("2"),Ro=o(", and the average of "),tt=s("code"),Do=o("3,2,1"),Co=o(" is "),it=s("code"),Wo=o("2"),Bo=o(" as well."),Fo=m(),ot=s("li"),p=s("p"),at=s("code"),Uo=o("median"),Lo=o(` - refers to the value in the middle of a list. The median value of
...
mode: the list `),yt=s("code"),la=o("1,1,2,3,3,4"),ha=o(" has two modes "),bt=s("code"),ua=o("1"),ma=o(" and "),vt=s("code"),fa=o("3"),gi=m(),C=s("h2"),W=s("a"),wt=s("span"),ca=o("Quick stats"),Ei=m(),ye=s("p"),da=o(`When we’re talking about statistical analysis, we’re normally talking about
...
distribution.`),ki=m(),B=s("figure"),be=s("img"),gt=s("figcaption"),pa=o("Normal distributions"),_i=m(),k=s("p"),ya=o("In a normal distribution, the "),Et=s("strong"),ba=o("mean"),va=o(", "),kt=s("strong"),wa=o("median"),ga=o(", and "),_t=s("strong"),Ea=o("mode"),ka=o(` mean exactly
...
shaped, they are skewed and known as asymmetric distributions.`),Ii=m(),F=s("figure"),we=s("img"),At=s("figcaption"),Aa=o("Asymmetric distributions"),Ti=m(),v=s("p"),Ia=o("The "),It=s("strong"),Ta=o("mean"),Pa=o(", "),Tt=s("strong"),Oa=o("median"),Sa=o(", and the "),Pt=s("strong"),xa=o("mode"),Ga=o(` will be three different things in
...
than the other.`),Pi=m(),ge=s("p"),Da=o(`And, while we’re on the subject of weird distributions, there is yet another
...
called multi-modal distributions.`),Oi=m(),U=s("figure"),Ee=s("img"),St=s("figcaption"),Ca=o("A bi-modal distribution"),Si=m(),ke=s("p"),Wa=o(`Those often happen in complex situations with lots of dependencies and
...
to peaks, one for the average female height and one for an average male height.`),xi=m(),L=s("h2"),j=s("a"),xt=s("span"),Ba=o("Estimations math"),Gi=m(),_e=s("p"),Fa=o(`When it comes to estimations, it doesn’t really matter what system a team uses,
...
with the estimation as any member of the team.`),Di=m(),Te=s("p"),ja=o("However funny that sounds, that is not the actual problem here."),Ci=m(),I=s("h2"),H=s("a"),Nt=s("span"),Ma=o("So, what "),Rt=s("em"),Ha=o("is"),Ya=o(" the problem?"),Wi=m(),Y=s("p"),qa=o(`The problem with the picture is this. When you’ve been asked to estimate
...
the more consistent they will be at pointing out the value.`),Bi=m(),q=s("p"),$a=o("But, what’s really implied here is the "),Ct=s("strong"),za=o("average"),Ka=o(` value. Because the general
...
sort it all out. And it will. Just not the way you think it should.`),Fi=m(),y=s("p"),Va=o(`What everyone is missing is the fact that in an asymmetric probabilities
distribution, the `),Wt=s("strong"),Xa=o("average"),Za=o(" is "),Bt=s("em"),es=o("always larger"),ts=o(" than the "),Ft=s("strong"),is=o("mode"),os=o(` or the
...
are`),ps=m(),K=s("li"),Yt=s("code"),ys=o("accuracy"),bs=o(" or "),qt=s("code"),vs=o("bias"),ws=o(" is how close the results are to the actual/true value"),Hi=m(),V=s("figure"),Se=s("img"),Jt=s("figcaption"),gs=o("Accuracy and precision"),Yi=m(),xe=s("p"),Es=o(`Or, in case of the estimation probabilities distribution graph, it looks like
so:`),qi=m(),X=s("figure"),Ge=s("img"),Qt=s("figcaption"),ks=o("Accuracy and precision on a graph"),Ji=m(),w=s("p"),_s=o(`You see now, you can whip your team endlessly into “getting better at
...
the `),Xt=s("strong"),Ds=o("mode"),Cs=o(" spread overlaps with the "),Zt=s("strong"),Ws=o("average"),Bs=o(` value. Everyone does this.
Either explicitly, or implicitly by using gimmicks like fibonacci numbers, and
averaging team members estimations.`),zi=m(),Z=s("h2"),ee=s("a"),ei=s("span"),Fs=o("The ugly truth"),Ki=m(),P=s("p"),Us=o(`The truth is that nobody knows how long work will really take ahead of time.
...
happens next?`),io=m(),We=s("p"),Vs=o(`If you finish early, your manager will think you’re probably not very skilled
...
longer. Either the case, they’ll probably assign you to more scrum training.`),oo=m(),Be=s("p"),Xs=o(`You see, the thing is, even in an idealised situation, you’re not supposed to
...
begin with.`),ao=m(),se=s("h2"),ne=s("a"),ni=s("span"),Zs=o("To a manager"),so=m(),Fe=s("p"),en=o(`Well, hello there. Since you’ve made it to management, chances are you’re smart
...
share in your circles. Thanks muchly, and I’ll see you next time!`),this.h()},l(e){G=n(e,"P",{});var l=r(G);go=a(l,`I’ve been through a fair bit of teams; and I have built and managed my own share
of them as well. I’ve seen teams that estimate in hours, I’ve seen teams that
estimate in points, in complexity, in t-shirts, and in pokemons. Okay, I haven’t
seen teams estimating in pokemons. But, I dare to say that they’d have exactly
...
some knowledge. Some of you are well versed in math and statistics, and I
apologise for dragging you through this. But, some are not, and I hope you’ll
find it useful.`),Yn.forEach(i),vi=f(e),pe=n(e,"P",{});var qn=r(pe);Io=a(qn,"Lets start with basic stats terminology:"),qn.forEach(i),wi=f(e),A=n(e,"UL",{});var Ye=r(A);Ke=n(Ye,"LI",{});var Jn=r(Ke);d=n(Jn,"P",{});var g=r(d);Ve=n(g,"CODE",{});var Qn=r(Ve);To=a(Qn,"average"),Qn.forEach(i),Po=a(g,", or "),Xe=n(g,"CODE",{});var $n=r(Xe);Oo=a($n,"mean"),$n.forEach(i),So=a(g,` for those in the US - means what you think it means. A
sum of the elements divided by the number of elements. The average of `),Ze=n(g,"CODE",{});var zn=r(Ze);xo=a(zn,"1,2,3"),zn.forEach(i),Go=a(g,`
is `),et=n(g,"CODE",{});var Kn=r(et);No=a(Kn,"2"),Kn.forEach(i),Ro=a(g,", and the average of "),tt=n(g,"CODE",{});var Vn=r(tt);Do=a(Vn,"3,2,1"),Vn.forEach(i),Co=a(g," is "),it=n(g,"CODE",{});var Xn=r(it);Wo=a(Xn,"2"),Xn.forEach(i),Bo=a(g," as well."),g.forEach(i),Jn.forEach(i),Fo=f(Ye),ot=n(Ye,"LI",{});var Zn=r(ot);p=n(Zn,"P",{});var E=r(p);at=n(E,"CODE",{});var er=r(at);Uo=a(er,"median"),er.forEach(i),Lo=a(E,` - refers to the value in the middle of a list. The median value of
...
mode: the list `),yt=n(b,"CODE",{});var fr=r(yt);la=a(fr,"1,1,2,3,3,4"),fr.forEach(i),ha=a(b," has two modes "),bt=n(b,"CODE",{});var cr=r(bt);ua=a(cr,"1"),cr.forEach(i),ma=a(b," and "),vt=n(b,"CODE",{});var dr=r(vt);fa=a(dr,"3"),dr.forEach(i),b.forEach(i),nr.forEach(i),Ye.forEach(i),gi=f(e),C=n(e,"H2",{id:!0});var vn=r(C);W=n(vn,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var pr=r(W);wt=n(pr,"SPAN",{class:!0}),r(wt).forEach(i),pr.forEach(i),ca=a(vn,"Quick stats"),vn.forEach(i),Ei=f(e),ye=n(e,"P",{});var yr=r(ye);da=a(yr,`When we’re talking about statistical analysis, we’re normally talking about
probabilities; more specifically we’re talking about probability distributions.
At which point people think about bell curves and what’s known as the “normal”
distribution.`),yr.forEach(i),ki=f(e),B=n(e,"FIGURE",{class:!0});var wn=r(B);be=n(wn,"IMG",{src:!0,alt:!0}),gt=n(wn,"FIGCAPTION",{});var br=r(gt);pa=a(br,"Normal distributions"),br.forEach(i),wn.forEach(i),_i=f(e),k=n(e,"P",{});var ue=r(k);ya=a(ue,"In a normal distribution, the "),Et=n(ue,"STRONG",{});var vr=r(Et);ba=a(vr,"mean"),vr.forEach(i),va=a(ue,", "),kt=n(ue,"STRONG",{});var wr=r(kt);wa=a(wr,"median"),wr.forEach(i),ga=a(ue,", and "),_t=n(ue,"STRONG",{});var gr=r(_t);Ea=a(gr,"mode"),gr.forEach(i),ka=a(ue,` mean exactly
the same thing: the peak of the bell curve. And the more difficult a problem is
...
important cases — and estimations fall into this category — are not bell
shaped, they are skewed and known as asymmetric distributions.`),Er.forEach(i),Ii=f(e),F=n(e,"FIGURE",{class:!0});var gn=r(F);we=n(gn,"IMG",{src:!0,alt:!0}),At=n(gn,"FIGCAPTION",{});var kr=r(At);Aa=a(kr,"Asymmetric distributions"),kr.forEach(i),gn.forEach(i),Ti=f(e),v=n(e,"P",{});var S=r(v);Ia=a(S,"The "),It=n(S,"STRONG",{});var _r=r(It);Ta=a(_r,"mean"),_r.forEach(i),Pa=a(S,", "),Tt=n(S,"STRONG",{});var Ar=r(Tt);Oa=a(Ar,"median"),Ar.forEach(i),Sa=a(S,", and the "),Pt=n(S,"STRONG",{});var Ir=r(Pt);xa=a(Ir,"mode"),Ir.forEach(i),Ga=a(S,` will be three different things in
...
the possible cases, and there are more possibilities on one side of the peak
than the other.`),S.forEach(i),Pi=f(e),ge=n(e,"P",{});var Pr=r(ge);Da=a(Pr,`And, while we’re on the subject of weird distributions, there is yet another
probability curve to keep in mind. Sometimes, there are more than one common
outcome, and that will result in the curve having multiple peaks. Those are
called multi-modal distributions.`),Pr.forEach(i),Oi=f(e),U=n(e,"FIGURE",{class:!0});var En=r(U);Ee=n(En,"IMG",{src:!0,alt:!0}),St=n(En,"FIGCAPTION",{});var Or=r(St);Ca=a(Or,"A bi-modal distribution"),Or.forEach(i),En.forEach(i),Si=f(e),ke=n(e,"P",{});var Sr=r(ke);Wa=a(Sr,`Those often happen in complex situations with lots of dependencies and
non-homogeneous data sources. For example, if you take the distribution of
people heights in a group that has a 1:1 ratio of males and females, you’d see
to peaks, one for the average female height and one for an average male height.`),Sr.forEach(i),xi=f(e),L=n(e,"H2",{id:!0});var kn=r(L);j=n(kn,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var xr=r(j);xt=n(xr,"SPAN",{class:!0}),r(xt).forEach(i),xr.forEach(i),Ba=a(kn,"Estimations math"),kn.forEach(i),Gi=f(e),_e=n(e,"P",{});var Gr=r(_e);Fa=a(Gr,`When it comes to estimations, it doesn’t really matter what system a team uses,
they all follow the same mathematical principles. They all go from zero to
infinity, and the probability of them being accurate can be represented by an
...
graph will be, with more peaks showing up. At some point it gets so muddy, that
a drunk monkey throwing a banana at the chart would have roughly as much luck
with the estimation as any member of the team.`),Rr.forEach(i),Di=f(e),Te=n(e,"P",{});var Dr=r(Te);ja=a(Dr,"However funny that sounds, that is not the actual problem here."),Dr.forEach(i),Ci=f(e),I=n(e,"H2",{id:!0});var mi=r(I);H=n(mi,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Cr=r(H);Nt=n(Cr,"SPAN",{class:!0}),r(Nt).forEach(i),Cr.forEach(i),Ma=a(mi,"So, what "),Rt=n(mi,"EM",{});var Wr=r(Rt);Ha=a(Wr,"is"),Wr.forEach(i),Ya=a(mi," the problem?"),mi.forEach(i),Wi=f(e),Y=n(e,"P",{});var po=r(Y);qa=a(po,`The problem with the picture is this. When you’ve been asked to estimate
something, what you think about is the `),Dt=n(po,"STRONG",{});var Br=r(Dt);Ja=a(Br,"mode"),Br.forEach(i),Qa=a(po,` value, or the most commonly
appearing outcome in your experience. And the more experienced an engineer is
the more consistent they will be at pointing out the value.`),po.forEach(i),Bi=f(e),q=n(e,"P",{});var yo=r(q);$a=a(yo,"But, what’s really implied here is the "),Ct=n(yo,"STRONG",{});var Fr=r(Ct);za=a(Fr,"average"),Fr.forEach(i),Ka=a(yo,` value. Because the general
mindset in estimations based planning is that you don’t have to be accurate with
each estimation, the law of averages will kick in at the end of the sprint and
sort it all out. And it will. Just not the way you think it should.`),yo.forEach(i),Fi=f(e),y=n(e,"P",{});var _=r(y);Va=a(_,`What everyone is missing is the fact that in an asymmetric probabilities
distribution, the `),Wt=n(_,"STRONG",{});var Ur=r(Wt);Xa=a(Ur,"average"),Ur.forEach(i),Za=a(_," is "),Bt=n(_,"EM",{});var Lr=r(Bt);es=a(Lr,"always larger"),Lr.forEach(i),ts=a(_," than the "),Ft=n(_,"STRONG",{});var jr=r(Ft);is=a(jr,"mode"),jr.forEach(i),os=a(_,` or the
...
are`),fi.forEach(i),ps=f(bo),K=n(bo,"LI",{});var ci=r(K);Yt=n(ci,"CODE",{});var zr=r(Yt);ys=a(zr,"accuracy"),zr.forEach(i),bs=a(ci," or "),qt=n(ci,"CODE",{});var Kr=r(qt);vs=a(Kr,"bias"),Kr.forEach(i),ws=a(ci," is how close the results are to the actual/true value"),ci.forEach(i),bo.forEach(i),Hi=f(e),V=n(e,"FIGURE",{class:!0});var In=r(V);Se=n(In,"IMG",{src:!0,alt:!0}),Jt=n(In,"FIGCAPTION",{});var Vr=r(Jt);gs=a(Vr,"Accuracy and precision"),Vr.forEach(i),In.forEach(i),Yi=f(e),xe=n(e,"P",{});var Xr=r(xe);Es=a(Xr,`Or, in case of the estimation probabilities distribution graph, it looks like
so:`),Xr.forEach(i),qi=f(e),X=n(e,"FIGURE",{class:!0});var Tn=r(X);Ge=n(Tn,"IMG",{src:!0,alt:!0}),Qt=n(Tn,"FIGCAPTION",{});var Zr=r(Qt);ks=a(Zr,"Accuracy and precision on a graph"),Zr.forEach(i),Tn.forEach(i),Ji=f(e),w=n(e,"P",{});var x=r(w);_s=a(x,`You see now, you can whip your team endlessly into “getting better at
estimations”, working on optimal tasks granularity, etc. And it all will go
wrong every single time. Because you will push the team to optimise for the
...
the `),Xt=n(qe,"STRONG",{});var sl=r(Xt);Ds=a(sl,"mode"),sl.forEach(i),Cs=a(qe," spread overlaps with the "),Zt=n(qe,"STRONG",{});var nl=r(Zt);Ws=a(nl,"average"),nl.forEach(i),Bs=a(qe,` value. Everyone does this.
Either explicitly, or implicitly by using gimmicks like fibonacci numbers, and
averaging team members estimations.`),qe.forEach(i),zi=f(e),Z=n(e,"H2",{id:!0});var Pn=r(Z);ee=n(Pn,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var rl=r(ee);ei=n(rl,"SPAN",{class:!0}),r(ei).forEach(i),rl.forEach(i),Fs=a(Pn,"The ugly truth"),Pn.forEach(i),Ki=f(e),P=n(e,"P",{});var Je=r(P);Us=a(Je,`The truth is that nobody knows how long work will really take ahead of time.
Because nobody experienced the tail end of the distribution where the
...
in your estimations. And, you might finish it in 2 hours, or you might finish it
in 6 with roughly the same probability (because your accuracy is great). What
happens next?`),vo.forEach(i),io=f(e),We=n(e,"P",{});var pl=r(We);Vs=a(pl,`If you finish early, your manager will think you’re probably not very skilled
because you had to overshoot your estimations by 100%. And if you finish late,
your manager will think you’re probably not very skilled because work took 50%
longer. Either the case, they’ll probably assign you to more scrum training.`),pl.forEach(i),oo=f(e),Be=n(e,"P",{});var yl=r(Be);Xs=a(yl,`You see, the thing is, even in an idealised situation, you’re not supposed to
win at this game no matter what. The moment you produce a number — be that
hours, points, or pokemons — you’re screwed. Because everyone’s expectations
will be anchored to the number one way or another. And it’s a wrong number to
begin with.`),yl.forEach(i),ao=f(e),se=n(e,"H2",{id:!0});var xn=r(se);ne=n(xn,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var bl=r(ne);ni=n(bl,"SPAN",{class:!0}),r(ni).forEach(i),bl.forEach(i),Zs=a(xn,"To a manager"),xn.forEach(i),so=f(e),Fe=n(e,"P",{});var vl=r(Fe);en=a(vl,`Well, hello there. Since you’ve made it to management, chances are you’re smart
and will be less prone to refuting factual information. So, I’ll be blunt with
you here. A manager has one job, to make sure that resources are applied
optimally. And if your “management style” is rooted in estimations, you won’t be
doing a stellar job at it. Here is why.`),vl.forEach(i),no=f(e),re=n(e,"P",{});var wo=r(re);tn=a(wo,`Due to the mathematical model I’ve described above, chances that your team’s
estimations will be accurate and precise are pretty slim. The only people who
deliver their projects consistently on time and budget is the US army; and they
do that by grossly overestimating everything that moves. For a business entity
that’s an `),ri=n(wo,"STRONG",{});var wl=r(ri);on=a(wl,"F"),wl.forEach(i),an=a(wo,` in resources allocation, which is basically your job
description.`),wo.forEach(i),ro=f(e),O=n(e,"P",{});var Qe=r(O);sn=a(Qe,`You obviously can’t underestimate requirements, because that’s a straight up
`),li=n(Qe,"STRONG",{});var gl=r(li);nn=a(gl,"F"),gl.forEach(i),rn=a(Qe,` in management. So, you’re most likely to try pushing the team to find some
form of a reasonable middle ground in their estimations. Due to the math I’ve
described above it will fail roughly 60% of the time. When your efforts will
eventually piss off enough senior engineers on the team, you will start paying
roughly $50-70k per person for replacements in cash money, all while delaying
...
eyeballs on my content. So, if you enjoyed the read, or find it useful, please
share in your circles. Thanks muchly, and I’ll see you next time!`),Pl.forEach(i),this.h()},h(){me(fe.src,Rn=zl)||u(fe,"src",Rn),u(fe,"alt","Dr. Evil agile"),u(N,"class","rehype-figure"),u(ze,"class","icon icon-link"),u(D,"aria-hidden","true"),u(D,"tabindex","-1"),u(D,"href","#quick-math"),u(R,"id","quick-math"),u(wt,"class","icon icon-link"),u(W,"aria-hidden","true"),u(W,"tabindex","-1"),u(W,"href","#quick-stats"),u(C,"id","quick-stats"),me(be.src,Dn=Kl)||u(be,"src",Dn),u(be,"alt","Normal distributions"),u(B,"class","rehype-figure"),me(we.src,Cn=Vl)||u(we,"src",Cn),u(we,"alt","Asymmetric distributions"),u(F,"class","rehype-figure"),me(Ee.src,Wn=Xl)||u(Ee,"src",Wn),u(Ee,"alt","A bi-modal distribution"),u(U,"class","rehype-figure"),u(xt,"class","icon icon-link"),u(j,"aria-hidden","true"),u(j,"tabindex","-1"),u(j,"href","#estimations-math"),u(L,"id","estimations-math"),me(Ae.src,Bn=Zl)||u(Ae,"src",Bn),u(Ae,"alt","Estimations probability"),u(M,"class","rehype-figure"),u(Nt,"class","icon icon-link"),u(H,"aria-hidden","true"),u(H,"tabindex","-1"),u(H,"href","#so-what-is-the-problem"),u(I,"id","so-what-is-the-problem"),u(jt,"class","icon icon-link"),u(Q,"aria-hidden","true"),u(Q,"tabindex","-1"),u(Q,"href","#accuracy-and-precision"),u(J,"id","accuracy-and-precision"),me(Se.src,Fn=eh)||u(Se,"src",Fn),u(Se,"alt","Accuracy and precision"),u(V,"class","rehype-figure"),me(Ge.src,Un=th)||u(Ge,"src",Un),u(Ge,"alt","Accuracy and precision on a graph"),u(X,"class","rehype-figure"),u(ei,"class","icon icon-link"),u(ee,"aria-hidden","true"),u(ee,"tabindex","-1"),u(ee,"href","#the-ugly-truth"),u(Z,"id","the-ugly-truth"),me(De.src,Ln=ih)||u(De,"src",Ln),u(De,"alt","You did this to yourself"),u(te,"class","rehype-figure"),u(ai,"class","icon icon-link"),u(oe,"aria-hidden","true"),u(oe,"tabindex","-1"),u(oe,"href","#the-final-chord"),u(ie,"id","the-final-chord"),u(ni,"class","icon icon-link"),u(ne,"aria-hidden","true"),u(ne,"tabindex","-1"),u(ne,"href","#to-a-manager"),u(se,"id","to-a-manager"),u(ui,"class","icon icon-link"),u(he,"aria-hidden","true"),u(he,"tabindex","-1"),u(he,"href","#so-what-now"),u(le,"id","so-what-now")},m(e,l){h(e,G,l),t(G,go),h(e,di,l),h(e,N,l),t(N,fe),t(N,$e),t($e,Eo),h(e,pi,l),h(e,ce,l),t(ce,ko),h(e,yi,l),h(e,R,l),t(R,D),t(D,ze),t(R,_o),h(e,bi,l),h(e,de,l),t(de,Ao),h(e,vi,l),h(e,pe,l),t(pe,Io),h(e,wi,l),h(e,A,l),t(A,Ke),t(Ke,d),t(d,Ve),t(Ve,To),t(d,Po),t(d,Xe),t(Xe,Oo),t(d,So),t(d,Ze),t(Ze,xo),t(d,Go),t(d,et),t(et,No),t(d,Ro),t(d,tt),t(tt,Do),t(d,Co),t(d,it),t(it,Wo),t(d,Bo),t(A,Fo),t(A,ot),t(ot,p),t(p,at),t(at,Uo),t(p,Lo),t(p,st),t(st,jo),t(p,Mo),t(p,nt),t(nt,Ho),t(p,Yo),t(p,rt),t(rt,qo),t(p,Jo),t(p,lt),t(lt,Qo),t(p,$o),t(p,ht),t(ht,zo),t(p,Ko),t(A,Vo),t(A,ut),t(ut,c),t(c,mt),t(mt,Xo),t(c,Zo),t(c,ft),t(ft,ea),t(c,ta),t(c,ct),t(ct,ia),t(c,oa),t(c,dt),t(dt,aa),t(c,sa),t(c,pt),t(pt,na),t(c,ra),t(c,yt),t(yt,la),t(c,ha),t(c,bt),t(bt,ua),t(c,ma),t(c,vt),t(vt,fa),h(e,gi,l),h(e,C,l),t(C,W),t(W,wt),t(C,ca),h(e,Ei,l),h(e,ye,l),t(ye,da),h(e,ki,l),h(e,B,l),t(B,be),t(B,gt),t(gt,pa),h(e,_i,l),h(e,k,l),t(k,ya),t(k,Et),t(Et,ba),t(k,va),t(k,kt),t(kt,wa),t(k,ga),t(k,_t),t(_t,Ea),t(k,ka),h(e,Ai,l),h(e,ve,l),t(ve,_a),h(e,Ii,l),h(e,F,l),t(F,we),t(F,At),t(At,Aa),h(e,Ti,l),h(e,v,l),t(v,Ia),t(v,It),t(It,Ta),t(v,Pa),t(v,Tt),t(Tt,Oa),t(v,Sa),t(v,Pt),t(Pt,xa),t(v,Ga),t(v,Ot),t(Ot,Na),t(v,Ra),h(e,Pi,l),h(e,ge,l),t(ge,Da),h(e,Oi,l),h(e,U,l),t(U,Ee),t(U,St),t(St,Ca),h(e,Si,l),h(e,ke,l),t(ke,Wa),h(e,xi,l),h(e,L,l),t(L,j),t(j,xt),t(L,Ba),h(e,Gi,l),h(e,_e,l),t(_e,Fa),h(e,Ni,l),h(e,M,l),t(M,Ae),t(M,Gt),t(Gt,Ua),h(e,Ri,l),h(e,Ie,l),t(Ie,La),h(e,Di,l),h(e,Te,l),t(Te,ja),h(e,Ci,l),h(e,I,l),t(I,H),t(H,Nt),t(I,Ma),t(I,Rt),t(Rt,Ha),t(I,Ya),h(e,Wi,l),h(e,Y,l),t(Y,qa),t(Y,Dt),t(Dt,Ja),t(Y,Qa),h(e,Bi,l),h(e,q,l),t(q,$a),t(q,Ct),t(Ct,za),t(q,Ka),h(e,Fi,l),h(e,y,l),t(y,Va),t(y,Wt),t(Wt,Xa),t(y,Za),t(y,Bt),t(Bt,es),t(y,ts),t(y,Ft),t(Ft,is),t(y,os),t(y,Ut),t(Ut,as),t(y,ss),t(y,Lt),t(Lt,ns),t(y,rs),h(e,Ui,l),h(e,Pe,l),t(Pe,ls),h(e,Li,l),h(e,J,l),t(J,Q),t(Q,jt),t(J,hs),h(e,ji,l),h(e,Oe,l),t(Oe,us),h(e,Mi,l),h(e,$,l),t($,z),t(z,Mt),t(Mt,ms),t(z,fs),t(z,Ht),t(Ht,cs),t(z,ds),t($,ps),t($,K),t(K,Yt),t(Yt,ys),t(K,bs),t(K,qt),t(qt,vs),t(K,ws),h(e,Hi,l),h(e,V,l),t(V,Se),t(V,Jt),t(Jt,gs),h(e,Yi,l),h(e,xe,l),t(xe,Es),h(e,qi,l),h(e,X,l),t(X,Ge),t(X,Qt),t(Qt,ks),h(e,Ji,l),h(e,w,l),t(w,_s),t(w,$t),t($t,As),t(w,Is),t(w,zt),t(zt,Ts),t(w,Ps),t(w,Kt),t(Kt,Os),t(w,Ss),t(w,Vt),t(Vt,xs),t(w,Gs),h(e,Qi,l),h(e,Ne,l),t(Ne,Ns),h(e,$i,l),h(e,T,l),t(T,Rs),t(T,Xt),t(Xt,Ds),t(T,Cs),t(T,Zt),t(Zt,Ws),t(T,Bs),h(e,zi,l),h(e,Z,l),t(Z,ee),t(ee,ei),t(Z,Fs),h(e,Ki,l),h(e,P,l),t(P,Us),t(P,ti),t(ti,Ls),t(P,js),t(P,ii),t(ii,Ms),t(P,Hs),h(e,Vi,l),h(e,Re,l),t(Re,Ys),h(e,Xi,l),h(e,te,l),t(te,De),t(te,oi),t(oi,qs),h(e,Zi,l),h(e,ie,l),t(ie,oe),t(oe,ai),t(ie,Js),h(e,eo,l),h(e,Ce,l),t(Ce,Qs),h(e,to,l),h(e,ae,l),t(ae,$s),t(ae,si),t(si,zs),t(ae,Ks),h(e,io,l),h(e,We,l),t(We,Vs),h(e,oo,l),h(e,Be,l),t(Be,Xs),h(e,ao,l),h(e,se,l),t(se,ne),t(ne,ni),t(se,Zs),h(e,so,l),h(e,Fe,l),t(Fe,en),h(e,no,l),h(e,re,l),t(re,tn),t(re,ri),t(ri,on),t(re,an),h(e,ro,l),h(e,O,l),t(O,sn),t(O,li),t(li,nn),t(O,rn),t(O,hi),t(hi,ln),t(O,hn),h(e,lo,l),h(e,Ue,l),t(Ue,un),h(e,ho,l),h(e,Le,l),t(Le,mn),h(e,uo,l),h(e,le,l),t(le,he),t(he,ui),t(le,fn),h(e,mo,l),h(e,je,l),t(je,cn),h(e,fo,l),h(e,Me,l),t(Me,dn),h(e,co,l),h(e,He,l),t(He,pn)},p:Nn,i:Nn,o:Nn,d(e){e&&i(G),e&&i(di),e&&i(N),e&&i(pi),e&&i(ce),e&&i(yi),e&&i(R),e&&i(bi),e&&i(de),e&&i(vi),e&&i(pe),e&&i(wi),e&&i(A),e&&i(gi),e&&i(C),e&&i(Ei),e&&i(ye),e&&i(ki),e&&i(B),e&&i(_i),e&&i(k),e&&i(Ai),e&&i(ve),e&&i(Ii),e&&i(F),e&&i(Ti),e&&i(v),e&&i(Pi),e&&i(ge),e&&i(Oi),e&&i(U),e&&i(Si),e&&i(ke),e&&i(xi),e&&i(L),e&&i(Gi),e&&i(_e),e&&i(Ni),e&&i(M),e&&i(Ri),e&&i(Ie),e&&i(Di),e&&i(Te),e&&i(Ci),e&&i(I),e&&i(Wi),e&&i(Y),e&&i(Bi),e&&i(q),e&&i(Fi),e&&i(y),e&&i(Ui),e&&i(Pe),e&&i(Li),e&&i(J),e&&i(ji),e&&i(Oe),e&&i(Mi),e&&i($),e&&i(Hi),e&&i(V),e&&i(Yi),e&&i(xe),e&&i(qi),e&&i(X),e&&i(Ji),e&&i(w),e&&i(Qi),e&&i(Ne),e&&i($i),e&&i(T),e&&i(zi),e&&i(Z),e&&i(Ki),e&&i(P),e&&i(Vi),e&&i(Re),e&&i(Xi),e&&i(te),e&&i(Zi),e&&i(ie),e&&i(eo),e&&i(Ce),e&&i(to),e&&i(ae),e&&i(io),e&&i(We),e&&i(oo),e&&i(Be),e&&i(ao),e&&i(se),e&&i(so),e&&i(Fe),e&&i(no),e&&i(re),e&&i(ro),e&&i(O),e&&i(lo),e&&i(Ue),e&&i(ho),e&&i(Le),e&&i(uo),e&&i(le),e&&i(mo),e&&i(je),e&&i(fo),e&&i(Me),e&&i(co),e&&i(He)}}}const sh={slug:"3OvR4",date:"22 Feb 2023",title:"Why estimations don't really work",description:"Destroying the hopes and dreams of those relying on estimations in their delivery planning",thumbnail:$l,tags:["planning","agile","management"]};class nh extends Sl{constructor(G){super(),xl(this,G,null,oh,Gl,{})}}export{nh as default,sh as metadata};
