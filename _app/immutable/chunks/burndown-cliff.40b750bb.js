import{S as Yn,i as Zn,s as ea,k as s,q as l,a as f,l as o,m as r,r as h,h as t,c as u,H as ta,n as p,b as i,E as n,G as dn}from"./index.7ee8938c.js";const na="png",aa=1200,ia=600,sa="srgb",oa=3,ra="uchar",la=132,ha=!1,fa="inch",ua=!0,pa=!1,ca=1,ma=void 0,da=!0,ya=!1,wa=""+new URL("../assets/burndown-charts.adcc2897.png",import.meta.url).href,va={format:na,width:aa,height:ia,space:sa,channels:oa,depth:ra,density:la,isProgressive:ha,resolutionUnit:fa,hasProfile:ua,hasAlpha:pa,orientation:ca,aspect:ma,withoutEnlargement:da,withoutReduction:ya,src:wa},ga=""+new URL("../assets/burndown-charts.34a3042c.webp",import.meta.url).href;function ba(Xn){let m,ot,ge,W,rt,be,d,H,yn,ae,lt,ke,L,ht,Ee,C,ft,_e,y,w,ie,ut,Ae,Q,pt,Ie,U,ct,Te,v,g,se,mt,Pe,F,dt,xe,K,yt,qe,M,wt,Oe,c,j,vt,oe,gt,bt,kt,R,Et,re,_t,At,It,G,Tt,le,Pt,xt,Se,b,qt,he,Ot,St,Be,k,Bt,fe,Nt,jt,Ne,E,Rt,ue,Gt,Wt,je,_,A,pe,Ht,Re,$,Lt,Ge,I,Ct,ce,Qt,Ut,We,z,Ft,He,D,Kt,Le,T,P,me,Mt,Ce,J,$t,Qe,x,zt,de,Dt,Jt,Ue,V,Vt,Fe,X,Xt,Ke,q,O,ye,Yt,Me,Y,Zt,$e,S,en,we,tn,nn,ze,Z,an,De,ee,sn,Je,B,N,ve,on,Ve,te,rn;return{c(){m=s("p"),ot=l(`Overtime, while working in management, everyone picks up shortcuts for assessing
...
and go do something else.`),be=f(),d=s("figure"),H=s("img"),ae=s("figcaption"),lt=l("Burndown chart types"),ke=f(),L=s("p"),ht=l(`Obviously, I’m not going to fire and hire anyone, that’s not how management
...
that need investigation.`),Ee=f(),C=s("p"),ft=l(`Today, I’m writing about one of those mental shortcuts and what’s the thinking
...
cliffs, and that’s what I’m going to go through in the rest of the post.`),je=f(),_=s("h2"),A=s("a"),pe=s("span"),Ht=l("Cliff type 1: chunky"),Re=f(),$=s("p"),Lt=l(`This type of cliffs often look like the bulk of the work is submitted in the
...
a delay, but the graph looks chunky.`),Ge=f(),I=s("p"),Ct=l("As the name implies the "),ce=s("strong"),Qt=l("chunky"),Ut=l(` cliff means that the team is not granular
...
planning to be on the safe side.`),He=f(),D=s("p"),Kt=l(`There are usually a few possible reasons for this. Either the team members were
...
into large buckets and off they go.`),Le=f(),T=s("h2"),P=s("a"),me=s("span"),Mt=l("Cliff type 2: the wall"),Ce=f(),J=s("p"),$t=l(`This type of cliffs often looks like the chunky cliff, but it might look like a
...
burndown charts. If the chart looks like a plateau, hire a tech lead; if it
looks like a cliff hire a PO; if it looks like a triangle, leave the team alone
and go do something else.`),wn.forEach(t),be=u(e),d=o(e,"FIGURE",{class:!0});var ln=r(d);H=o(ln,"IMG",{src:!0,alt:!0}),ae=o(ln,"FIGCAPTION",{});var vn=r(ae);lt=h(vn,"Burndown chart types"),vn.forEach(t),ln.forEach(t),ke=u(e),L=o(e,"P",{});var gn=r(L);ht=h(gn,`Obviously, I’m not going to fire and hire anyone, that’s not how management
works. And, I might actually have a completely wrong idea about what’s going on.
But, at the same time, I know, that if there is something wrong with the
burndown charts, sprint after sprint consistently, there are usually reasons
that need investigation.`),gn.forEach(t),Ee=u(e),C=o(e,"P",{});var bn=r(C);ft=h(bn,`Today, I’m writing about one of those mental shortcuts and what’s the thinking
...
involved as a manager. There are multiple specific situations that produce
cliffs, and that’s what I’m going to go through in the rest of the post.`),nt.forEach(t),je=u(e),_=o(e,"H2",{id:!0});var un=r(_);A=o(un,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var jn=r(A);pe=o(jn,"SPAN",{class:!0}),r(pe).forEach(t),jn.forEach(t),Ht=h(un,"Cliff type 1: chunky"),un.forEach(t),Re=u(e),$=o(e,"P",{});var Rn=r($);Lt=h(Rn,`This type of cliffs often look like the bulk of the work is submitted in the
last minute. Or sometimes it manifests as a series of smaller cliffs that look
like huge steps on the chart. The work is usually mostly done, occasionally with
a delay, but the graph looks chunky.`),Rn.forEach(t),Ge=u(e),I=o(e,"P",{});var at=r(I);Ct=h(at,"As the name implies the "),ce=o(at,"STRONG",{});var Gn=r(ce);Qt=h(Gn,"chunky"),Gn.forEach(t),Ut=h(at,` cliff means that the team is not granular
enough in their estimations and planning. Tickets are often estimated in days
worth of effort. Hence when the items are delivered the are represented as big
...
team is playing the game conservatively. In a way it is the overestimation
coping behaviour, just in a different format: the team does a rather shallow
planning to be on the safe side.`),Wn.forEach(t),He=u(e),D=o(e,"P",{});var Hn=r(D);Kt=h(Hn,`There are usually a few possible reasons for this. Either the team members were
never taught effective planning techniques. Or there is a lack of trust between
product and engineering, which results in engineers not having enough insight
into the problem, or not having enough time to do the proper investigation and
planning. In the end of the planning session, the work just roughly shovelled
into large buckets and off they go.`),Hn.forEach(t),Le=u(e),T=o(e,"H2",{id:!0});var pn=r(T);P=o(pn,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Ln=r(P);me=o(Ln,"SPAN",{class:!0}),r(me).forEach(t),Ln.forEach(t),Mt=h(pn,"Cliff type 2: the wall"),pn.forEach(t),Ce=u(e),J=o(e,"P",{});var Cn=r(J);$t=h(Cn,`This type of cliffs often looks like the chunky cliff, but it might look like a
cliff hanger too (see below). The reason why it’s a separate type is that it has
a different kind of a problem underneath. In this case the process is at fault.`),Cn.forEach(t),Qe=u(e),x=o(e,"P",{});var it=r(x);zt=h(it,"The "),de=o(it,"STRONG",{});var Qn=r(de);Dt=h(Qn,"wall"),Qn.forEach(t),Jt=h(it,` in this instance refers to that mythical wall over which work is
often thrown. And it usually works like so. Work is dutifully estimated, and
then generously padded because those pesky QA people — who either sit quietly
in the corner, or not even present in the meeting — love to throw the work back
over the wall. Sometimes that is a PO playing the QA role. And sometimes, in
