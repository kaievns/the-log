import{S as Yr,i as Fr,s as Gr,k as i,q as l,a as u,l as s,m as r,r as h,h as t,c as m,n as d,b as a,E as n,G as us}from"./index.7ee8938c.js";const Kr="png",Qr=1200,Jr=600,Vr="srgb",Xr=3,$r="uchar",Zr=132,el=!1,tl="inch",nl=!0,ol=!1,al=1,il=void 0,sl=!0,rl=!1,ll=""+new URL("../assets/no-estimations.2461ce33.png",import.meta.url).href,hl={format:Kr,width:Qr,height:Jr,space:Vr,channels:Xr,depth:$r,density:Zr,isProgressive:el,resolutionUnit:tl,hasProfile:nl,hasAlpha:ol,orientation:al,aspect:il,withoutEnlargement:sl,withoutReduction:rl,src:ll};function ul(zr){let y,ko,Z,Eo,_o,Dt,ee,Io,Rt,b,g,et,Po,zt,te,Ao,Yt,w,To,tt,xo,qo,nt,So,Wo,Ft,ne,Mo,Gt,p,oe,ot,Bo,jo,Co,ae,at,Oo,Ho,No,ie,it,Uo,Lo,Do,se,st,Ro,zo,Kt,re,Yo,Qt,v,k,rt,Fo,lt,Go,Ko,Jt,le,Qo,Vt,E,Jo,ht,Vo,Xo,Xt,f,$o,ut,Zo,ea,mt,ta,na,dt,oa,aa,$t,he,ia,Zt,_,sa,pt,ra,la,en,I,P,ft,ha,tn,ue,ua,nn,A,ma,ct,da,pa,on,T,fa,yt,ca,ya,an,me,wa,sn,de,va,rn,x,q,wt,ba,ln,S,ga,vt,ka,Ea,hn,pe,_a,un,W,Ia,bt,Pa,Aa,mn,fe,Ta,dn,ce,xa,pn,ye,qa,fn,we,Sa,cn,M,B,gt,Wa,yn,ve,Ma,wn,be,ge,kt,Ba,ja,vn,ke,Ca,bn,Ee,Oa,gn,_e,Ie,Et,Ha,Na,kn,Pe,Ua,En,Ae,La,_n,Te,Da,In,xe,Ra,Pn,j,C,_t,za,An,O,Ya,It,Fa,Ga,Tn,H,Pt,Ka,Qa,qe,Ja,At,Va,xn,Se,Xa,qn,We,$a,Sn,Me,Za,Wn,Be,ei,Mn,je,ti,Bn,Ce,ni,jn,N,U,Tt,oi,Cn,Oe,ai,On,He,ii,Hn,Ne,si,Nn,Ue,ri,Un,c,li,xt,hi,ui,qt,mi,di,St,pi,fi,Ln,Le,ci,Dn,L,D,Wt,yi,Rn,De,wi,zn,Re,vi,Yn,ze,bi,Fn,R,gi,Mt,ki,Ei,Gn,Ye,_i,Kn,Fe,Ii,Qn,Ge,Pi,Jn,z,Ai,Bt,Ti,xi,Vn,Y,F,jt,qi,Xn,Ke,Si,$n,Qe,Wi,Zn,Je,Mi,eo,Ve,Bi,to,Xe,ji,no,G,Ci,Ct,Oi,Hi,oo,K,Ni,Ot,Ui,Li,ao,Q,Di,Ht,Ri,zi,io,J,Nt,Yi,Fi,$e,Gi,Ut,Ki;return{c(){y=i("p"),ko=l(`Welcome to the part two of our little estimations chat. Having committed some
...
responsibility. And when the manager can answer the question of `),nt=i("em"),So=l("when"),Wo=l(` something
...
sessions start.`),Gt=u(),p=i("blockquote"),oe=i("p"),ot=i("em"),Bo=l("Developer"),jo=l(": I have no idea, so I better double the number"),Co=u(),ae=i("p"),at=i("em"),Oo=l("Manager"),Ho=l(": Those devs have no idea, so I better double their estimate"),No=u(),ie=i("p"),it=i("em"),Uo=l("Boss"),Lo=l(": Managers fail to deliver 60% of the time, so I better double it"),Do=u(),se=i("p"),st=i("em"),Ro=l("Customer"),zo=l(": They have no idea, so I’ll just complain until it’s done"),Kt=u(),re=i("p"),Yo=l(`Everyone wants certainty. Predictability in life makes us all feel warm and
...
in disruptive software engineering — there is no such thing as certainty.`),Qt=u(),v=i("h2"),k=i("a"),rt=i("span"),Fo=l("Do we "),lt=i("em"),Go=l("have to"),Ko=l(" estimate?"),Jt=u(),le=i("p"),Qo=l(`Unlike a factory floor where you can measure repeated work, and estimate, and
...
with the best intentions.`),rn=u(),x=i("h2"),q=i("a"),wt=i("span"),ba=l("High integrity commitments"),ln=u(),S=i("p"),ga=l(`Fortunately, we don’t live in the lala land. There are partners, public
...
be charged a premium for the predictability of the delivery.`),un=u(),W=i("p"),Ia=l(`Here is the rub though. Unless you’re shipping a video game on physical disks,
...
necessary; iteratively.`),fn=u(),we=i("p"),Sa=l(`And that is why the bulk of the industry is moving towards continuous delivery
those days rather than keep failing deadlines.`),cn=u(),M=i("h2"),B=i("a"),gt=i("span"),Wa=l("Consider consistency"),yn=u(),ve=i("p"),Ma=l(`When it comes to accountability the vast majority of companies that struggle
...
company, and it usually sounds like so:`),wn=u(),be=i("blockquote"),ge=i("p"),kt=i("em"),Ba=l("Boss"),ja=l(": I have this idea, how much will it cost me to build?"),vn=u(),ke=i("p"),Ca=l(`And here is our whole problem in a nut shell. We estimate an idea that has no
...
doubling them again.`),Pn=u(),j=i("h2"),C=i("a"),_t=i("span"),za=l("Planning with iterations in mind"),An=u(),O=i("p"),Ya=l("At this point, an observant reader is probably thinking to themselves. "),It=i("em"),Fa=l(`Didn’t
we come a whole circle? First, I’ve spent so much time bashing on estimations,
and then told you to estimate anyway.`),Ga=l(` And in a way you’re not wrong. But, there
is a key difference, and I hope you’re starting to see it by now.`),Tn=u(),H=i("blockquote"),Pt=i("p"),Ka=l("all plans eventually fail, but planning is essential"),Qa=u(),qe=i("p"),Ja=l("— "),At=i("cite"),Va=l("an old military saying"),xn=u(),Se=i("p"),Xa=l(`When you estimate to deliver on time and budget, you are forced to stick with
...
going to disappoint either your boss or your developers.`),qn=u(),We=i("p"),$a=l(`When you’re estimating a goal, the actual plan specifics and the estimations
...
onto the next one.`),Sn=u(),Me=i("p"),Za=l(`The ultimate destination we are striving for here is to start thinking about the
...
your team should ship something to production on a daily basis.`),Wn=u(),Be=i("p"),ei=l(`To achieve this type of consistent output, rather than estimating better, the
...
experiments rather than iterations.`),Mn=u(),je=i("p"),ti=l(`Let me stress this again, a team might or might not formally estimate, they
...
as it will take.`),Bn=u(),Ce=i("p"),ni=l("Such is the agile way."),jn=u(),N=i("h2"),U=i("a"),Tt=i("span"),oi=l("Reporting without estimations"),Cn=u(),Oe=i("p"),ai=l(`Well, that’s all nice and dandy, but what about the boss and the fortnightly
...
thing from making `),St=i("em"),pi=l("promises"),fi=l(` on behalf of the team. You don’t have to commit to
...
deliver.`),Dn=u(),L=i("h2"),D=i("a"),Wt=i("span"),yi=l("Engineer’s performance without estimations"),Rn=u(),De=i("p"),wi=l(`The last point I want to address here is engineers performance measurement.
...
responsibilities on them, nobody is going to love you for that.`),Gn=u(),Ye=i("p"),_i=l(`In fact, how do you know that when a developer ships on time they are performing
...
That’s right, you don’t.`),Kn=u(),Fe=i("p"),Ii=l(`The only reliable way to make sure software engineers are doing their best is to
give them interesting, well defined, and meaningful work to do, and then empower
them to make their own decisions.`),Qn=u(),Ge=i("p"),Pi=l(`So, don’t ask developers how much it will cost to build your idea. They are not
...
stakeholder feedback. People will always tell you what the numbers can’t.`),Vn=u(),Y=i("h2"),F=i("a"),jt=i("span"),qi=l("Wrapping up"),Xn=u(),Ke=i("p"),Si=l(`In a contemporary product team environment, the product is never done. In the
...
thing that really matters.`),$n=u(),Qe=i("p"),Wi=l(`In this context the best way forward is to obsess over figuring out what is the
...
controlling the production costs.`),to=u(),Xe=i("p"),ji=l(`And in that light what a business really should control is that the customer
...
path to optimal performance.`),no=u(),G=i("p"),Ci=l(`In the end of the day running a business is an exercise in risk management, and
the biggest risk any software business has is not that `),Ct=i("em"),Oi=l("some"),Hi=l(` work might take
...
to course correct and make sure that doesn’t happen.`),oo=u(),K=i("p"),Ni=l("There is a place for estimations. They can be used effectively to "),Ot=i("em"),Ui=l("eyeball"),Li=l(`
...
estimations and reality as a guide whether the team does enough discovery work.`),ao=u(),Q=i("p"),Di=l(`But, when estimations turn into a bludgeoning weapon and used to routinely
...
for sure that just ain’t so.`),Fi=u(),$e=i("p"),Gi=l("— "),Ut=i("cite"),Ki=l("Mark Twain"),this.h()},l(e){y=s(e,"P",{});var o=r(y);ko=h(o,`Welcome to the part two of our little estimations chat. Having committed some
rather `),Z=s(o,"A",{href:!0});var ms=r(Z);Eo=h(ms,"strongly worded criticism"),ms.forEach(t),_o=h(o,` of the ubiquitous practice of
estimating everything that moves in software engineering, I feel strongly that I
shan’t leave without offering an alternative. Hence, the part two.`),o.forEach(t),Dt=m(e),ee=s(e,"P",{});var ds=r(ee);Io=h(ds,"Let’s just dive into this."),ds.forEach(t),Rt=m(e),b=s(e,"H2",{id:!0});var Qi=r(b);g=s(Qi,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var ps=r(g);et=s(ps,"SPAN",{class:!0}),r(et).forEach(t),ps.forEach(t),Po=h(Qi,"Why do we estimate anyway?"),Qi.forEach(t),zt=m(e),te=s(e,"P",{});var fs=r(te);Ao=h(fs,`If we get to the bottom of it, the role of a manager is to manage resources. As
in to make sure resources are not wasted on useless efforts. And managers have
their own bosses. And those bosses tend to be allergic to sophistry. Bosses want
to see a progress. And they want to see it in basic fonts, black and white
colours, and preferably with some numbers. Which is actually fair, because the
...
responsibility. And when the manager can answer the question of `),nt=s(Ze,"EM",{});var ys=r(nt);So=h(ys,"when"),ys.forEach(t),Wo=h(Ze,` something
...
have some numbers that they can latch onto. And that is where the BS bingo
sessions start.`),ws.forEach(t),Gt=m(e),p=s(e,"BLOCKQUOTE",{});var V=r(p);oe=s(V,"P",{});var Ji=r(oe);ot=s(Ji,"EM",{});var vs=r(ot);Bo=h(vs,"Developer"),vs.forEach(t),jo=h(Ji,": I have no idea, so I better double the number"),Ji.forEach(t),Co=m(V),ae=s(V,"P",{});var Vi=r(ae);at=s(Vi,"EM",{});var bs=r(at);Oo=h(bs,"Manager"),bs.forEach(t),Ho=h(Vi,": Those devs have no idea, so I better double their estimate"),Vi.forEach(t),No=m(V),ie=s(V,"P",{});var Xi=r(ie);it=s(Xi,"EM",{});var gs=r(it);Uo=h(gs,"Boss"),gs.forEach(t),Lo=h(Xi,": Managers fail to deliver 60% of the time, so I better double it"),Xi.forEach(t),Do=m(V),se=s(V,"P",{});var $i=r(se);st=s($i,"EM",{});var ks=r(st);Ro=h(ks,"Customer"),ks.forEach(t),zo=h($i,": They have no idea, so I’ll just complain until it’s done"),$i.forEach(t),V.forEach(t),Kt=m(e),re=s(e,"P",{});var Es=r(re);Yo=h(Es,`Everyone wants certainty. Predictability in life makes us all feel warm and
fuzzy on the inside. And so we estimate, to feed our need for certainty with
estimations. The problem is though, that in software engineering — especially
in disruptive software engineering — there is no such thing as certainty.`),Es.forEach(t),Qt=m(e),v=s(e,"H2",{id:!0});var Lt=r(v);k=s(Lt,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var _s=r(k);rt=s(_s,"SPAN",{class:!0}),r(rt).forEach(t),_s.forEach(t),Fo=h(Lt,"Do we "),lt=s(Lt,"EM",{});var Is=r(lt);Go=h(Is,"have to"),Is.forEach(t),Ko=h(Lt," estimate?"),Lt.forEach(t),Jt=m(e),le=s(e,"P",{});var Ps=r(le);Qo=h(Ps,`Unlike a factory floor where you can measure repeated work, and estimate, and
assign confidence levels. In software engineering, most products have virtually
zero marginal cost and need to be produced only once. Which means, that, in
...
because there are two separate problems here: budgeting and commitments.`),X.forEach(t),$t=m(e),he=s(e,"P",{});var Ss=r(he);ia=h(Ss,`Budgeting is internal, it is ultimately about resources allocation. And I
strongly on the side that one doesn’t need estimations to make solid progress.
Actually, estimations will hinder the progress more than help.`),Ss.forEach(t),Zt=m(e),_=s(e,"P",{});var ro=r(_);sa=h(ro,`Commitments are external by nature. But, again not all commitments are made
equal. What we really want to think about is the `),pt=s(ro,"EM",{});var Ws=r(pt);ra=h(Ws,"high integrity"),Ws.forEach(t),la=h(ro,` commitments.
And for those we will need a deadline and estimations. But, generally speaking,
...
a cost center. Instead of actively working `),ct=s(lo,"EM",{});var js=r(ct);da=h(js,"on the business"),js.forEach(t),pa=h(lo,`, and contributing
to the bottom line, they are providing services to the company. And they are
expected to do so on time and budget, or else. It is credulous to expect optimal
...
on how long it will actually take. And if your company is in the business of
innovation — like most modern software engineering companies are — the bulk of
work that engineers do is the mission critical work; work that `),yt=s(ho,"EM",{});var Cs=r(yt);ca=h(Cs,"has to be done"),Cs.forEach(t),ya=h(ho,`
...
estimations, and then triple them again. You should have redundancy, contingency
plans, and at least two escape hatches. It is expected that your customer will
be charged a premium for the predictability of the delivery.`),Ls.forEach(t),un=m(e),W=s(e,"P",{});var mo=r(W);Ia=h(mo,`Here is the rub though. Unless you’re shipping a video game on physical disks,
or something similar, those situations are quite rare in the grand schema of
...
commitments and estimations, we can remove paddings and deliver things cheaper
and faster, the agile way. Because we will focus on building only what’s
necessary; iteratively.`),Ys.forEach(t),fn=m(e),we=s(e,"P",{});var Fs=r(we);Sa=h(Fs,`And that is why the bulk of the industry is moving towards continuous delivery
those days rather than keep failing deadlines.`),Fs.forEach(t),cn=m(e),M=s(e,"H2",{id:!0});var ts=r(M);B=s(ts,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Gs=r(B);gt=s(Gs,"SPAN",{class:!0}),r(gt).forEach(t),Gs.forEach(t),Wa=h(ts,"Consider consistency"),ts.forEach(t),yn=m(e),ve=s(e,"P",{});var Ks=r(ve);Ma=h(Ks,`When it comes to accountability the vast majority of companies that struggle
with estimations have it backwards. Usually, this coincides with “visionary”
leadership within the company. Visionary leadership and estimations drama go
hand in hand because of the inherent dynamic in the decisions making within the
company, and it usually sounds like so:`),Ks.forEach(t),wn=m(e),be=s(e,"BLOCKQUOTE",{});var Qs=r(be);ge=s(Qs,"P",{});var ns=r(ge);kt=s(ns,"EM",{});var Js=r(kt);Ba=h(Js,"Boss"),Js.forEach(t),ja=h(ns,": I have this idea, how much will it cost me to build?"),ns.forEach(t),Qs.forEach(t),vn=m(e),ke=s(e,"P",{});var Vs=r(ke);Ca=h(Vs,`And here is our whole problem in a nut shell. We estimate an idea that has no
market proof with tools that have no working math under them. And we do all that
while treating literally the smartest people in the company as orders takers. No
...
doubling them again.`),or.forEach(t),Pn=m(e),j=s(e,"H2",{id:!0});var as=r(j);C=s(as,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var ar=r(C);_t=s(ar,"SPAN",{class:!0}),r(_t).forEach(t),ar.forEach(t),za=h(as,"Planning with iterations in mind"),as.forEach(t),An=m(e),O=s(e,"P",{});var po=r(O);Ya=h(po,"At this point, an observant reader is probably thinking to themselves. "),It=s(po,"EM",{});var ir=r(It);Fa=h(ir,`Didn’t
we come a whole circle? First, I’ve spent so much time bashing on estimations,
and then told you to estimate anyway.`),ir.forEach(t),Ga=h(po,` And in a way you’re not wrong. But, there
is a key difference, and I hope you’re starting to see it by now.`),po.forEach(t),Tn=m(e),H=s(e,"BLOCKQUOTE",{});var fo=r(H);Pt=s(fo,"P",{});var sr=r(Pt);Ka=h(sr,"all plans eventually fail, but planning is essential"),sr.forEach(t),Qa=m(fo),qe=s(fo,"P",{});var is=r(qe);Ja=h(is,"— "),At=s(is,"CITE",{});var rr=r(At);Va=h(rr,"an old military saying"),rr.forEach(t),is.forEach(t),fo.forEach(t),xn=m(e),Se=s(e,"P",{});var lr=r(Se);Xa=h(lr,`When you estimate to deliver on time and budget, you are forced to stick with
the original plan, because you make commitments. And, as you know by now, that
plan doesn’t usually have any solid reasons to succeed. Sooner or later you’re
going to disappoint either your boss or your developers.`),lr.forEach(t),qn=m(e),We=s(e,"P",{});var hr=r(We);$a=h(hr,`When you’re estimating a goal, the actual plan specifics and the estimations
don’t matter. What really matters is reaching the goal of the iteration, because
you have all agreed that this is the best value you can deliver right now. You
actually can throw the plan and estimations away mid-iteration — or at any
point really — and make a new plan. Sometimes you find another way towards the
goal, and sometimes you realise that the goal or your approach was less than
great. So you just abandon the goal with the minimal financial impact and move
onto the next one.`),hr.forEach(t),Sn=m(e),Me=s(e,"P",{});var ur=r(Me);Za=h(ur,`The ultimate destination we are striving for here is to start thinking about the
delivery as a series of experiments. Each taking say roughly 2-3 weeks of
effort. And you normally might want to have a few milestones on the way. Ideally
your team should ship something to production on a daily basis.`),ur.forEach(t),Wn=m(e),Be=s(e,"P",{});var mr=r(Be);ei=h(mr,`To achieve this type of consistent output, rather than estimating better, the
team will need to spend enough time in discovery and experimentation, and then
setting up their own goals. That’s why we prefer to refer to those ideally as
experiments rather than iterations.`),mr.forEach(t),Mn=m(e),je=s(e,"P",{});var dr=r(je);ti=h(dr,`Let me stress this again, a team might or might not formally estimate, they
might do this with whatever granularity and accuracy they want. In fact, if the
team produces estimations, those numbers should not leave the team boundaries;
because they’re meaningless outside of the team. All that matters is a rough
plan that has all the critical work mapped out, and an agreement that the goal
is worth pursuing. With that in mind, the work should be allowed to take as much
as it will take.`),dr.forEach(t),Bn=m(e),Ce=s(e,"P",{});var pr=r(Ce);ni=h(pr,"Such is the agile way."),pr.forEach(t),jn=m(e),N=s(e,"H2",{id:!0});var ss=r(N);U=s(ss,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var fr=r(U);Tt=s(fr,"SPAN",{class:!0}),r(Tt).forEach(t),fr.forEach(t),oi=h(ss,"Reporting without estimations"),ss.forEach(t),Cn=m(e),Oe=s(e,"P",{});var cr=r(Oe);ai=h(cr,`Well, that’s all nice and dandy, but what about the boss and the fortnightly
...
their own estimations based on this information, but that is a very different
thing from making `),St=s($,"EM",{});var kr=r(St);pi=h(kr,"promises"),kr.forEach(t),fi=h($,` on behalf of the team. You don’t have to commit to
...
Developers are ICs and they are here to build stuff. Don’t shift your direct
responsibilities on them, nobody is going to love you for that.`),co.forEach(t),Gn=m(e),Ye=s(e,"P",{});var xr=r(Ye);_i=h(xr,`In fact, how do you know that when a developer ships on time they are performing
optimally? Maybe they overestimate and then just pretend to be busy. Or, how do
you even know that they’re doing what they’re supposed to do when they sit next
to you in the office? How do you know they’re not just writing a poignant haiku
in CSS right now, because they’re pissed at your attempts to police their work?
That’s right, you don’t.`),xr.forEach(t),Kn=m(e),Fe=s(e,"P",{});var qr=r(Fe);Ii=h(qr,`The only reliable way to make sure software engineers are doing their best is to
give them interesting, well defined, and meaningful work to do, and then empower
them to make their own decisions.`),qr.forEach(t),Qn=m(e),Ge=s(e,"P",{});var Sr=r(Ge);Pi=h(Sr,`So, don’t ask developers how much it will cost to build your idea. They are not
here to enact your Steve Jobs fantasy. Feed them the strategic context, make
sure they understand the importance of their work, and then let them choose
their own goals.`),Sr.forEach(t),Jn=m(e),z=s(e,"P",{});var yo=r(z);Ai=h(yo,"If you really "),Bt=s(yo,"EM",{});var Wr=r(Bt);Ti=h(Wr,"have to"),Wr.forEach(t),xi=h(yo,` measure developers performance, and there is no way
around this in your organisation, then do it properly through peer and
stakeholder feedback. People will always tell you what the numbers can’t.`),yo.forEach(t),Vn=m(e),Y=s(e,"H2",{id:!0});var ls=r(Y);F=s(ls,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Mr=r(F);jt=s(Mr,"SPAN",{class:!0}),r(jt).forEach(t),Mr.forEach(t),qi=h(ls,"Wrapping up"),ls.forEach(t),Xn=m(e),Ke=s(e,"P",{});var Br=r(Ke);Si=h(Br,`In a contemporary product team environment, the product is never done. In the
environment of ever changing competitive landscape and user preferences, market
fit is everything. Which means that shipping what the users want is the only
thing that really matters.`),Br.forEach(t),$n=m(e),Qe=s(e,"P",{});var jr=r(Qe);Wi=h(jr,`In this context the best way forward is to obsess over figuring out what is the
right thing to build and prioritising that which delivers the most user value.
The goal is to get into the market as quickly as possible, and deliver as much
user value as possible.`),jr.forEach(t),Zn=m(e),Je=s(e,"P",{});var Cr=r(Je);Mi=h(Cr,`Because software has virtually zero marginal cost; also known as the cost of
producing an additional item. As long as the company produces software that the
user wants, and there is enough market, the actual production cost doesn’t
matter all that much. And that means estimations don’t really add a whole lot of
value to the process.`),Cr.forEach(t),eo=m(e),Ve=s(e,"P",{});var Or=r(Ve);Bi=h(Or,`I understand that this sounds rather blasphemous to those running the business,
because in the end of the day there is a budget, investors, and partnerships
involved. But, at the same time, you know that I am not wrong. The only way to
build a stable cash flow is to build something that customers value and ready to
pay for. And the faster we do that the faster the financials will improve. Which
means that maximising the customer value is vastly more important than
controlling the production costs.`),Or.forEach(t),to=m(e),Xe=s(e,"P",{});var Hr=r(Xe);ji=h(Hr,`And in that light what a business really should control is that the customer
research is religiously conducted, critical work is visibly mapped out, and the
team consistently builds the most important item in every iteration. That is the
path to optimal performance.`),Hr.forEach(t),no=m(e),G=s(e,"P",{});var wo=r(G);Ci=h(wo,`In the end of the day running a business is an exercise in risk management, and
the biggest risk any software business has is not that `),Ct=s(wo,"EM",{});var Nr=r(Ct);Oi=h(Nr,"some"),Nr.forEach(t),Hi=h(wo,` work might take
300% longer than expected, the biggest risk is that the team would build a wrong
product. Consistent iterative development is the tool that allows the businesses
to course correct and make sure that doesn’t happen.`),wo.forEach(t),oo=m(e),K=s(e,"P",{});var vo=r(K);Ni=h(vo,"There is a place for estimations. They can be used effectively to "),Ot=s(vo,"EM",{});var Ur=r(Ot);Ui=h(Ur,"eyeball"),Ur.forEach(t),Li=h(vo,`
whether a goal fits an iteration cycle. Or as a rough idea for a high integrity
commitments planning. We can even constructively use comparisons between the
estimations and reality as a guide whether the team does enough discovery work.`),vo.forEach(t),ao=m(e),Q=s(e,"P",{});var bo=r(Q);Di=h(bo,`But, when estimations turn into a bludgeoning weapon and used to routinely
...
for sure that just ain’t so.`),Dr.forEach(t),Fi=m(go),$e=s(go,"P",{});var hs=r($e);Gi=h(hs,"— "),Ut=s(hs,"CITE",{});var Rr=r(Ut);Ki=h(Rr,"Mark Twain"),Rr.forEach(t),hs.forEach(t),go.forEach(t),this.h()},h(){d(Z,"href","/posts/3OvR4"),d(et,"class","icon icon-link"),d(g,"aria-hidden","true"),d(g,"tabindex","-1"),d(g,"href","#why-do-we-estimate-anyway"),d(b,"id","why-do-we-estimate-anyway"),d(rt,"class","icon icon-link"),d(k,"aria-hidden","true"),d(k,"tabindex","-1"),d(k,"href","#do-we-have-to-estimate"),d(v,"id","do-we-have-to-estimate"),d(ft,"class","icon icon-link"),d(P,"aria-hidden","true"),d(P,"tabindex","-1"),d(P,"href","#beyond-budgeting"),d(I,"id","beyond-budgeting"),d(wt,"class","icon icon-link"),d(q,"aria-hidden","true"),d(q,"tabindex","-1"),d(q,"href","#high-integrity-commitments"),d(x,"id","high-integrity-commitments"),d(gt,"class","icon icon-link"),d(B,"aria-hidden","true"),d(B,"tabindex","-1"),d(B,"href","#consider-consistency"),d(M,"id","consider-consistency"),d(_t,"class","icon icon-link"),d(C,"aria-hidden","true"),d(C,"tabindex","-1"),d(C,"href","#planning-with-iterations-in-mind"),d(j,"id","planning-with-iterations-in-mind"),d(Tt,"class","icon icon-link"),d(U,"aria-hidden","true"),d(U,"tabindex","-1"),d(U,"href","#reporting-without-estimations"),d(N,"id","reporting-without-estimations"),d(Wt,"class","icon icon-link"),d(D,"aria-hidden","true"),d(D,"tabindex","-1"),d(D,"href","#engineers-performance-without-estimations"),d(L,"id","engineers-performance-without-estimations"),d(jt,"class","icon icon-link"),d(F,"aria-hidden","true"),d(F,"tabindex","-1"),d(F,"href","#wrapping-up"),d(Y,"id","wrapping-up")},m(e,o){a(e,y,o),n(y,ko),n(y,Z),n(Z,Eo),n(y,_o),a(e,Dt,o),a(e,ee,o),n(ee,Io),a(e,Rt,o),a(e,b,o),n(b,g),n(g,et),n(b,Po),a(e,zt,o),a(e,te,o),n(te,Ao),a(e,Yt,o),a(e,w,o),n(w,To),n(w,tt),n(tt,xo),n(w,qo),n(w,nt),n(nt,So),n(w,Wo),a(e,Ft,o),a(e,ne,o),n(ne,Mo),a(e,Gt,o),a(e,p,o),n(p,oe),n(oe,ot),n(ot,Bo),n(oe,jo),n(p,Co),n(p,ae),n(ae,at),n(at,Oo),n(ae,Ho),n(p,No),n(p,ie),n(ie,it),n(it,Uo),n(ie,Lo),n(p,Do),n(p,se),n(se,st),n(st,Ro),n(se,zo),a(e,Kt,o),a(e,re,o),n(re,Yo),a(e,Qt,o),a(e,v,o),n(v,k),n(k,rt),n(v,Fo),n(v,lt),n(lt,Go),n(v,Ko),a(e,Jt,o),a(e,le,o),n(le,Qo),a(e,Vt,o),a(e,E,o),n(E,Jo),n(E,ht),n(ht,Vo),n(E,Xo),a(e,Xt,o),a(e,f,o),n(f,$o),n(f,ut),n(ut,Zo),n(f,ea),n(f,mt),n(mt,ta),n(f,na),n(f,dt),n(dt,oa),n(f,aa),a(e,$t,o),a(e,he,o),n(he,ia),a(e,Zt,o),a(e,_,o),n(_,sa),n(_,pt),n(pt,ra),n(_,la),a(e,en,o),a(e,I,o),n(I,P),n(P,ft),n(I,ha),a(e,tn,o),a(e,ue,o),n(ue,ua),a(e,nn,o),a(e,A,o),n(A,ma),n(A,ct),n(ct,da),n(A,pa),a(e,on,o),a(e,T,o),n(T,fa),n(T,yt),n(yt,ca),n(T,ya),a(e,an,o),a(e,me,o),n(me,wa),a(e,sn,o),a(e,de,o),n(de,va),a(e,rn,o),a(e,x,o),n(x,q),n(q,wt),n(x,ba),a(e,ln,o),a(e,S,o),n(S,ga),n(S,vt),n(vt,ka),n(S,Ea),a(e,hn,o),a(e,pe,o),n(pe,_a),a(e,un,o),a(e,W,o),n(W,Ia),n(W,bt),n(bt,Pa),n(W,Aa),a(e,mn,o),a(e,fe,o),n(fe,Ta),a(e,dn,o),a(e,ce,o),n(ce,xa),a(e,pn,o),a(e,ye,o),n(ye,qa),a(e,fn,o),a(e,we,o),n(we,Sa),a(e,cn,o),a(e,M,o),n(M,B),n(B,gt),n(M,Wa),a(e,yn,o),a(e,ve,o),n(ve,Ma),a(e,wn,o),a(e,be,o),n(be,ge),n(ge,kt),n(kt,Ba),n(ge,ja),a(e,vn,o),a(e,ke,o),n(ke,Ca),a(e,bn,o),a(e,Ee,o),n(Ee,Oa),a(e,gn,o),a(e,_e,o),n(_e,Ie),n(Ie,Et),n(Et,Ha),n(Ie,Na),a(e,kn,o),a(e,Pe,o),n(Pe,Ua),a(e,En,o),a(e,Ae,o),n(Ae,La),a(e,_n,o),a(e,Te,o),n(Te,Da),a(e,In,o),a(e,xe,o),n(xe,Ra),a(e,Pn,o),a(e,j,o),n(j,C),n(C,_t),n(j,za),a(e,An,o),a(e,O,o),n(O,Ya),n(O,It),n(It,Fa),n(O,Ga),a(e,Tn,o),a(e,H,o),n(H,Pt),n(Pt,Ka),n(H,Qa),n(H,qe),n(qe,Ja),n(qe,At),n(At,Va),a(e,xn,o),a(e,Se,o),n(Se,Xa),a(e,qn,o),a(e,We,o),n(We,$a),a(e,Sn,o),a(e,Me,o),n(Me,Za),a(e,Wn,o),a(e,Be,o),n(Be,ei),a(e,Mn,o),a(e,je,o),n(je,ti),a(e,Bn,o),a(e,Ce,o),n(Ce,ni),a(e,jn,o),a(e,N,o),n(N,U),n(U,Tt),n(N,oi),a(e,Cn,o),a(e,Oe,o),n(Oe,ai),a(e,On,o),a(e,He,o),n(He,ii),a(e,Hn,o),a(e,Ne,o),n(Ne,si),a(e,Nn,o),a(e,Ue,o),n(Ue,ri),a(e,Un,o),a(e,c,o),n(c,li),n(c,xt),n(xt,hi),n(c,ui),n(c,qt),n(qt,mi),n(c,di),n(c,St),n(St,pi),n(c,fi),a(e,Ln,o),a(e,Le,o),n(Le,ci),a(e,Dn,o),a(e,L,o),n(L,D),n(D,Wt),n(L,yi),a(e,Rn,o),a(e,De,o),n(De,wi),a(e,zn,o),a(e,Re,o),n(Re,vi),a(e,Yn,o),a(e,ze,o),n(ze,bi),a(e,Fn,o),a(e,R,o),n(R,gi),n(R,Mt),n(Mt,ki),n(R,Ei),a(e,Gn,o),a(e,Ye,o),n(Ye,_i),a(e,Kn,o),a(e,Fe,o),n(Fe,Ii),a(e,Qn,o),a(e,Ge,o),n(Ge,Pi),a(e,Jn,o),a(e,z,o),n(z,Ai),n(z,Bt),n(Bt,Ti),n(z,xi),a(e,Vn,o),a(e,Y,o),n(Y,F),n(F,jt),n(Y,qi),a(e,Xn,o),a(e,Ke,o),n(Ke,Si),a(e,$n,o),a(e,Qe,o),n(Qe,Wi),a(e,Zn,o),a(e,Je,o),n(Je,Mi),a(e,eo,o),a(e,Ve,o),n(Ve,Bi),a(e,to,o),a(e,Xe,o),n(Xe,ji),a(e,no,o),a(e,G,o),n(G,Ci),n(G,Ct),n(Ct,Oi),n(G,Hi),a(e,oo,o),a(e,K,o),n(K,Ni),n(K,Ot),n(Ot,Ui),n(K,Li),a(e,ao,o),a(e,Q,o),n(Q,Di),n(Q,Ht),n(Ht,Ri),n(Q,zi),a(e,io,o),a(e,J,o),n(J,Nt),n(Nt,Yi),n(J,Fi),n(J,$e),n($e,Gi),n($e,Ut),n(Ut,Ki)},p:us,i:us,o:us,d(e){e&&t(y),e&&t(Dt),e&&t(ee),e&&t(Rt),e&&t(b),e&&t(zt),e&&t(te),e&&t(Yt),e&&t(w),e&&t(Ft),e&&t(ne),e&&t(Gt),e&&t(p),e&&t(Kt),e&&t(re),e&&t(Qt),e&&t(v),e&&t(Jt),e&&t(le),e&&t(Vt),e&&t(E),e&&t(Xt),e&&t(f),e&&t($t),e&&t(he),e&&t(Zt),e&&t(_),e&&t(en),e&&t(I),e&&t(tn),e&&t(ue),e&&t(nn),e&&t(A),e&&t(on),e&&t(T),e&&t(an),e&&t(me),e&&t(sn),e&&t(de),e&&t(rn),e&&t(x),e&&t(ln),e&&t(S),e&&t(hn),e&&t(pe),e&&t(un),e&&t(W),e&&t(mn),e&&t(fe),e&&t(dn),e&&t(ce),e&&t(pn),e&&t(ye),e&&t(fn),e&&t(we),e&&t(cn),e&&t(M),e&&t(yn),e&&t(ve),e&&t(wn),e&&t(be),e&&t(vn),e&&t(ke),e&&t(bn),e&&t(Ee),e&&t(gn),e&&t(_e),e&&t(kn),e&&t(Pe),e&&t(En),e&&t(Ae),e&&t(_n),e&&t(Te),e&&t(In),e&&t(xe),e&&t(Pn),e&&t(j),e&&t(An),e&&t(O),e&&t(Tn),e&&t(H),e&&t(xn),e&&t(Se),e&&t(qn),e&&t(We),e&&t(Sn),e&&t(Me),e&&t(Wn),e&&t(Be),e&&t(Mn),e&&t(je),e&&t(Bn),e&&t(Ce),e&&t(jn),e&&t(N),e&&t(Cn),e&&t(Oe),e&&t(On),e&&t(He),e&&t(Hn),e&&t(Ne),e&&t(Nn),e&&t(Ue),e&&t(Un),e&&t(c),e&&t(Ln),e&&t(Le),e&&t(Dn),e&&t(L),e&&t(Rn),e&&t(De),e&&t(zn),e&&t(Re),e&&t(Yn),e&&t(ze),e&&t(Fn),e&&t(R),e&&t(Gn),e&&t(Ye),e&&t(Kn),e&&t(Fe),e&&t(Qn),e&&t(Ge),e&&t(Jn),e&&t(z),e&&t(Vn),e&&t(Y),e&&t(Xn),e&&t(Ke),e&&t($n),e&&t(Qe),e&&t(Zn),e&&t(Je),e&&t(eo),e&&t(Ve),e&&t(to),e&&t(Xe),e&&t(no),e&&t(G),e&&t(oo),e&&t(K),e&&t(ao),e&&t(Q),e&&t(io),e&&t(J)}}}const dl={slug:"i8lyo",date:"6 March 2023",title:"Life without estimations",description:"Part two of the estimations rant",thumbnail:hl,tags:["management","leadership","planning","agile"],medium:{tags:["Engineering management","Software engineering","Planning","Agile","Scrum"],id:"3502adec5e56"}};class pl extends Yr{constructor(y){super(),Fr(this,y,null,ul,Gr,{})}}export{pl as default,dl as metadata};
