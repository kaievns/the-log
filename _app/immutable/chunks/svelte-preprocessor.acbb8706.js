import{S as dt,i as mt,s as ft,k as p,q as c,a as r,l as o,m as l,r as i,h as a,c as k,n as u,b as e,E as s,G as ys}from"./index.7ee8938c.js";const yt="jpeg",vt=1200,wt=533,gt="srgb",bt=3,Et="uchar",_t=72,It="4:2:0",jt=!1,At=!1,Pt=!1,xt=1,Mt=2.25140712945591,Tt=!0,St=!1,Ht=""+new URL("../assets/svelte-balls.81dbce81.jpeg",import.meta.url).href,Ct={format:yt,width:vt,height:wt,space:gt,channels:bt,depth:Et,density:_t,chromaSubsampling:It,isProgressive:jt,hasProfile:At,hasAlpha:Pt,orientation:xt,aspect:Mt,withoutEnlargement:Tt,withoutReduction:St,src:Ht};function Lt(Vs){let v,ia,In,Y,ua,jn,w,g,en,ra,An,b,ka,L,ha,da,Pn,V,ma,xn,O,Fs=`<code class="language-undefined">---
title: My article
thumbnail: ./local-image.jpg
...
---</code>`,Mn,F,fa,Tn,D,Js=`<code class="language-md"><span class="token front-matter-block"><span class="token punctuation">---</span>
...
<span class="token punctuation">&#125;</span></code>`,Dn,I,ja,cn,Aa,Pa,Rn,m,xa,un,Ma,Ta,rn,Sa,Ha,Wn,j,A,kn,Ca,Bn,Q,La,Nn,W,Qs=`<code class="language-js"><span class="token keyword">const</span> myPlugin <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  ...
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">;</span></code>`,Un,f,Oa,hn,Da,Ra,dn,Wa,Ba,qn,X,Na,Gn,B,Xs=`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> parse<span class="token punctuation">,</span> walk <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">"svelte/compiler"</span><span class="token punctuation">;</span>
...
<span class="token keyword">const</span> myPlugin <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">async</span> <span class="token function">markup</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">&#123;</span> content<span class="token punctuation">,</span> filename <span class="token punctuation">&#125;</span></span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">;</span></code>`,$n,P,Ua,N,qa,Ga,zn,U,Zs=`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> parse<span class="token punctuation">,</span> walk <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">"svelte/compiler"</span><span class="token punctuation">;</span>
...
<span class="token keyword">const</span> myPlugin <span class="token operator">=</span> <span class="token punctuation">&#123;</span>
  <span class="token keyword">async</span> <span class="token function">markup</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">&#123;</span> content<span class="token punctuation">,</span> filename <span class="token punctuation">&#125;</span></span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">;</span></code>`,Yn,x,M,mn,$a,Vn,y,za,fn,Ya,Va,yn,Fa,Ja,Fn,q,nt=`<code class="language-svelte"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>module<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
the rest of the content</code>`,Jn,T,Ka,vn,Qa,Xa,Kn,S,Za,wn,ns,as,Qn,G,at=`<code class="language-js"><span class="token function">walk</span><span class="token punctuation">(</span>ast<span class="token punctuation">.</span>module<span class="token punctuation">,</span> <span class="token punctuation">&#123;</span>
  <span class="token function">enter</span><span class="token punctuation">(</span><span class="token parameter">node</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`,Xn,H,ss,gn,ts,es,Zn,$,st=`<code class="language-svelte"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>module<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
the rest of the content</code>`,na,h,ps,bn,os,ls,En,cs,is,_n,us,rs,aa,z,tt=`<code class="language-svelte"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>ts<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
files just fine. It’s actually pretty darn great at it.`),Pn=r(),V=p("p"),ma=c(`The thing is though, it doesn’t really preprocess the front-matter metadata. And
...
like everything else:`),xn=r(),O=p("pre"),Mn=r(),F=p("p"),fa=c(`I could in theory just use mdsvex for what it was designed for and just import
...
the content into an AST and traverse the tree. Svelte is pretty dope like that.`),Gn=r(),B=p("pre"),$n=r(),P=p("p"),Ua=c(`You probably don’t want to edit the original content manually, though. And
instead use something like the
`),N=p("a"),qa=c("magic-string"),Ga=c(` package to safely
edit your codebase, and generate the source-map for your changes. Like so:`),zn=r(),U=p("pre"),Yn=r(),x=p("h2"),M=p("a"),mn=p("span"),$a=c("An example"),Vn=r(),y=p("p"),za=c("I have my little thumbnail preprocessing function plugged in "),fn=p("em"),Ya=c("after"),Va=c(` the mdsvex
does its thing. Meaning it sees an already processed markdown file that was
turned into a `),yn=p("code"),Fa=c(".svelte"),Ja=c(` file. And at the header of it will have a module
declaration string that looks like so:`),Fn=r(),q=p("pre"),Jn=r(),T=p("p"),Ka=c("What I want my plugin to do is to find that "),vn=p("code"),Qa=c("metadata"),Xa=c(` const declaration and
...
use the `),wn=p("code"),ns=c("magic-string"),as=c(" to safely patch the declaration."),Qn=r(),G=p("pre"),Xn=r(),H=p("p"),ss=c("And that’s all there is to it. In the end this plugin will produce a "),gn=p("code"),ts=c(".svelte"),es=c(`
file that looks somewhat like this:`),Zn=r(),$=p("pre"),na=r(),h=p("p"),ps=c("And so, when the file is finally imported by svelte it will have the "),bn=p("code"),os=c("thumbnail"),ls=c(`
...
add it to the open graph meta tags like so:`),aa=r(),z=p("pre"),sa=r(),Z=p("p"),ks=c("And that’s pretty much the whole story. Enjoy!"),this.h()},l(n){v=o(n,"P",{});var t=l(v);ia=i(t,`The other day I needed to do a bit of a weird thing in Svelte on this website,
and I ended up making a small preprocessor plugin. It’s a fun little project,
...
files just fine. It’s actually pretty darn great at it.`),ta.forEach(a),Pn=k(n),V=o(n,"P",{});var bs=l(V);ma=i(bs,`The thing is though, it doesn’t really preprocess the front-matter metadata. And
that’s a problem for me because I want to specify thumbnail images for my
articles, and I want those images to be processed by the svelte/vite pipelines
like everything else:`),bs.forEach(a),xn=k(n),O=o(n,"PRE",{class:!0});var et=l(O);et.forEach(a),Mn=k(n),F=o(n,"P",{});var Es=l(F);fa=i(Es,`I could in theory just use mdsvex for what it was designed for and just import
...
the content into an AST and traverse the tree. Svelte is pretty dope like that.`),Os.forEach(a),Gn=k(n),B=o(n,"PRE",{class:!0});var ct=l(B);ct.forEach(a),$n=k(n),P=o(n,"P",{});var pa=l(P);Ua=i(pa,`You probably don’t want to edit the original content manually, though. And
instead use something like the
`),N=o(pa,"A",{href:!0,rel:!0});var Ds=l(N);qa=i(Ds,"magic-string"),Ds.forEach(a),Ga=i(pa,` package to safely
edit your codebase, and generate the source-map for your changes. Like so:`),pa.forEach(a),zn=k(n),U=o(n,"PRE",{class:!0});var it=l(U);it.forEach(a),Yn=k(n),x=o(n,"H2",{id:!0});var fs=l(x);M=o(fs,"A",{"aria-hidden":!0,tabindex:!0,href:!0});var Rs=l(M);mn=o(Rs,"SPAN",{class:!0}),l(mn).forEach(a),Rs.forEach(a),$a=i(fs,"An example"),fs.forEach(a),Vn=k(n),y=o(n,"P",{});var tn=l(y);za=i(tn,"I have my little thumbnail preprocessing function plugged in "),fn=o(tn,"EM",{});var Ws=l(fn);Ya=i(Ws,"after"),Ws.forEach(a),Va=i(tn,` the mdsvex
does its thing. Meaning it sees an already processed markdown file that was
turned into a `),yn=o(tn,"CODE",{});var Bs=l(yn);Fa=i(Bs,".svelte"),Bs.forEach(a),Ja=i(tn,` file. And at the header of it will have a module
declaration string that looks like so:`),tn.forEach(a),Fn=k(n),q=o(n,"PRE",{class:!0});var ut=l(q);ut.forEach(a),Jn=k(n),T=o(n,"P",{});var oa=l(T);Ka=i(oa,"What I want my plugin to do is to find that "),vn=o(oa,"CODE",{});var Ns=l(vn);Qa=i(Ns,"metadata"),Ns.forEach(a),Xa=i(oa,` const declaration and
replace it with a svelte native image import; preferably with the imagetools
...
use the `),wn=o(la,"CODE",{});var Us=l(wn);ns=i(Us,"magic-string"),Us.forEach(a),as=i(la," to safely patch the declaration."),la.forEach(a),Qn=k(n),G=o(n,"PRE",{class:!0});var rt=l(G);rt.forEach(a),Xn=k(n),H=o(n,"P",{});var ca=l(H);ss=i(ca,"And that’s all there is to it. In the end this plugin will produce a "),gn=o(ca,"CODE",{});var qs=l(gn);ts=i(qs,".svelte"),qs.forEach(a),es=i(ca,`
file that looks somewhat like this:`),ca.forEach(a),Zn=k(n),$=o(n,"PRE",{class:!0});var kt=l($);kt.forEach(a),na=k(n),h=o(n,"P",{});var C=l(h);ps=i(C,"And so, when the file is finally imported by svelte it will have the "),bn=o(C,"CODE",{});var Gs=l(bn);os=i(Gs,"thumbnail"),Gs.forEach(a),ls=i(C,`
property on the `),En=o(C,"CODE",{});var $s=l(En);cs=i($s,"metadata"),$s.forEach(a),is=i(C," export. And that "),_n=o(C,"CODE",{});var zs=l(_n);us=i(zs,"thumbnail"),zs.forEach(a),rs=i(C,` will be a regular Svelte
image import. Which, you can then use normally anywhere in the app, for example
add it to the open graph meta tags like so:`),C.forEach(a),aa=k(n),z=o(n,"PRE",{class:!0});var ht=l(z);ht.forEach(a),sa=k(n),Z=o(n,"P",{});var Ys=l(Z);ks=i(Ys,"And that’s pretty much the whole story. Enjoy!"),Ys.forEach(a),this.h()},h(){u(en,"class","icon icon-link"),u(g,"aria-hidden","true"),u(g,"tabindex","-1"),u(g,"href","#whats-the-problem"),u(w,"id","whats-the-problem"),u(L,"href","https://mdsvex.pngwn.io"),u(L,"rel","nofollow"),u(O,"class","language-undefined"),u(D,"class","language-md"),u(pn,"class","icon icon-link"),u(_,"aria-hidden","true"),u(_,"tabindex","-1"),u(_,"href","#svelte-pre-processing-plugins"),u(E,"id","svelte-pre-processing-plugins"),u(R,"class","language-js"),u(kn,"class","icon icon-link"),u(A,"aria-hidden","true"),u(A,"tabindex","-1"),u(A,"href","#how-does-it-work"),u(j,"id","how-does-it-work"),u(W,"class","language-js"),u(B,"class","language-js"),u(N,"href","https://www.npmjs.com/package/magic-string"),u(N,"rel","nofollow"),u(U,"class","language-js"),u(mn,"class","icon icon-link"),u(M,"aria-hidden","true"),u(M,"tabindex","-1"),u(M,"href","#an-example"),u(x,"id","an-example"),u(q,"class","language-svelte"),u(G,"class","language-js"),u($,"class","language-svelte"),u(z,"class","language-svelte")},m(n,t){e(n,v,t),s(v,ia),e(n,In,t),e(n,Y,t),s(Y,ua),e(n,jn,t),e(n,w,t),s(w,g),s(g,en),s(w,ra),e(n,An,t),e(n,b,t),s(b,ka),s(b,L),s(L,ha),s(b,da),e(n,Pn,t),e(n,V,t),s(V,ma),e(n,xn,t),e(n,O,t),O.innerHTML=Fs,e(n,Mn,t),e(n,F,t),s(F,fa),e(n,Tn,t),e(n,D,t),D.innerHTML=Js,e(n,Sn,t),e(n,J,t),s(J,ya),e(n,Hn,t),e(n,K,t),s(K,va),e(n,Cn,t),e(n,E,t),s(E,_),s(_,pn),s(E,wa),e(n,Ln,t),e(n,d,t),s(d,ga),s(d,on),s(on,ba),s(d,Ea),s(d,ln),s(ln,_a),s(d,Ia),e(n,On,t),e(n,R,t),R.innerHTML=Ks,e(n,Dn,t),e(n,I,t),s(I,ja),s(I,cn),s(cn,Aa),s(I,Pa),e(n,Rn,t),e(n,m,t),s(m,xa),s(m,un),s(un,Ma),s(m,Ta),s(m,rn),s(rn,Sa),s(m,Ha),e(n,Wn,t),e(n,j,t),s(j,A),s(A,kn),s(j,Ca),e(n,Bn,t),e(n,Q,t),s(Q,La),e(n,Nn,t),e(n,W,t),W.innerHTML=Qs,e(n,Un,t),e(n,f,t),s(f,Oa),s(f,hn),s(hn,Da),s(f,Ra),s(f,dn),s(dn,Wa),s(f,Ba),e(n,qn,t),e(n,X,t),s(X,Na),e(n,Gn,t),e(n,B,t),B.innerHTML=Xs,e(n,$n,t),e(n,P,t),s(P,Ua),s(P,N),s(N,qa),s(P,Ga),e(n,zn,t),e(n,U,t),U.innerHTML=Zs,e(n,Yn,t),e(n,x,t),s(x,M),s(M,mn),s(x,$a),e(n,Vn,t),e(n,y,t),s(y,za),s(y,fn),s(fn,Ya),s(y,Va),s(y,yn),s(yn,Fa),s(y,Ja),e(n,Fn,t),e(n,q,t),q.innerHTML=nt,e(n,Jn,t),e(n,T,t),s(T,Ka),s(T,vn),s(vn,Qa),s(T,Xa),e(n,Kn,t),e(n,S,t),s(S,Za),s(S,wn),s(wn,ns),s(S,as),e(n,Qn,t),e(n,G,t),G.innerHTML=at,e(n,Xn,t),e(n,H,t),s(H,ss),s(H,gn),s(gn,ts),s(H,es),e(n,Zn,t),e(n,$,t),$.innerHTML=st,e(n,na,t),e(n,h,t),s(h,ps),s(h,bn),s(bn,os),s(h,ls),s(h,En),s(En,cs),s(h,is),s(h,_n),s(_n,us),s(h,rs),e(n,aa,t),e(n,z,t),z.innerHTML=tt,e(n,sa,t),e(n,Z,t),s(Z,ks)},p:ys,i:ys,o:ys,d(n){n&&a(v),n&&a(In),n&&a(Y),n&&a(jn),n&&a(w),n&&a(An),n&&a(b),n&&a(Pn),n&&a(V),n&&a(xn),n&&a(O),n&&a(Mn),n&&a(F),n&&a(Tn),n&&a(D),n&&a(Sn),n&&a(J),n&&a(Hn),n&&a(K),n&&a(Cn),n&&a(E),n&&a(Ln),n&&a(d),n&&a(On),n&&a(R),n&&a(Dn),n&&a(I),n&&a(Rn),n&&a(m),n&&a(Wn),n&&a(j),n&&a(Bn),n&&a(Q),n&&a(Nn),n&&a(W),n&&a(Un),n&&a(f),n&&a(qn),n&&a(X),n&&a(Gn),n&&a(B),n&&a($n),n&&a(P),n&&a(zn),n&&a(U),n&&a(Yn),n&&a(x),n&&a(Vn),n&&a(y),n&&a(Fn),n&&a(q),n&&a(Jn),n&&a(T),n&&a(Kn),n&&a(S),n&&a(Qn),n&&a(G),n&&a(Xn),n&&a(H),n&&a(Zn),n&&a($),n&&a(na),n&&a(h),n&&a(aa),n&&a(z),n&&a(sa),n&&a(Z)}}}const Dt={slug:"nIAeA",date:"1 March 2023",title:"How to make a svelte preprocessor",description:"A bit of a deep dive into Svelte plugins system",thumbnail:Ct,tags:["svelte","javascript"]};class Rt extends dt{constructor(v){super(),mt(this,v,null,Lt,ft,{})}}export{Rt as default,Dt as metadata};
