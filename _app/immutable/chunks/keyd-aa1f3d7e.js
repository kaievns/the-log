import{S as lt,i as rt,s as ht,k as l,q as i,a as u,l as r,m as h,r as s,h as e,c as d,n as S,b as n,F as o,C as U}from"./index-920be987.js";function ut(st){let y,K,T,b,z,_,k,q,W,w,O,x,g,L,E,p,R,m,X,Y,P,v,H,A,f,D,c,F,G,B,I,J,M,j,N;return{c(){y=l("p"),K=i(`So, I run a custom keyboard layout. I designed one almost 10 years ago and it
...
the whole layouts thing. Which is pretty neat.`),x=u(),g=l("p"),L=i(`Turned out there are a couple of similar options on linux side too. What they
do, they basically hijack input directly from kernel/udev, transform it and then
feed it back into a virtual keyboard.`),E=u(),p=l("p"),R=i("The most known project is probably "),m=l("a"),X=i("kmonad"),Y=i(`.
...
two new computer languages to configure my keyboard.`),P=u(),v=l("p"),H=i(`I mean I did give it a go anyways, and it actually works pretty okay. But I also
...
it’s just the processing delay of a haskell thing.`),A=u(),f=l("p"),D=i(`Luckily there is another similar project called
`),c=l("a"),F=i("keyd"),G=i(` It’s a bit less feature rich than kmonad,
...
so ever with the thing.`),B=u(),I=l("p"),J=i(`So, yeah, just wanted to give the author some props. I’ve managed to setup my
...
keyboard and then read the system input, remap the crap out of it and then feed
that into the virtual keyboard and feed it back into the system hence bypassing
the whole layouts thing. Which is pretty neat.`),$.forEach(e),x=d(t),g=r(t,"P",{});var tt=h(g);L=s(tt,`Turned out there are a couple of similar options on linux side too. What they
do, they basically hijack input directly from kernel/udev, transform it and then
feed it back into a virtual keyboard.`),tt.forEach(e),E=d(t),p=r(t,"P",{});var C=h(p);R=s(C,"The most known project is probably "),m=r(C,"A",{href:!0,rel:!0});var et=h(m);X=s(et,"kmonad"),et.forEach(e),Y=s(C,`.
It’s actually pretty great, they even try to emulate some of the QMK features
like mod-taps and such which are pretty neat. There are a few drawbacks to the
project though. As far as I understand it the development of the project has
stopped years ago. It’s written in Haskell, there are binaries, but it will
likely install half of the internet to compile it. And configs are written in a
c-lisp. I mean, both are amazing languages, but fuck my life if i have to learn
two new computer languages to configure my keyboard.`),C.forEach(e),P=d(t),v=r(t,"P",{});var at=h(v);H=s(at,`I mean I did give it a go anyways, and it actually works pretty okay. But I also
felt that there was a distinct input lag with it, especially if i start messing
with mod-taps. I don’t know what’s the deal there, whether the fact that I’m
running on a beloved old thinkpad, or because the algo gets a bit confused, or
it’s just the processing delay of a haskell thing.`),at.forEach(e),A=d(t),f=r(t,"P",{});var Q=h(f);D=s(Q,`Luckily there is another similar project called
`),c=r(Q,"A",{href:!0,rel:!0});var nt=h(c);F=s(nt,"keyd"),nt.forEach(e),G=s(Q,` It’s a bit less feature rich than kmonad,
but there are a few advantages to it too. It’s actively maintained, it’s written
in C, and configuration is in TOML-ish config. It’s fully baked with systemd and
available as a proper system level package, and the installation and
configuration was pretty breezy actually. Also, I can’t see any input lag what
so ever with the thing.`),Q.forEach(e),B=d(t),I=r(t,"P",{});var ot=h(I);J=s(ot,`So, yeah, just wanted to give the author some props. I’ve managed to setup my
layout and mac like key bindings for everything pretty quickly, and it works
great, it terminal, all apps, including electron ones are just fine. Pretty much
...
love to have some decent mod-tap and home row mods setup. That’d make my day for
sure.`),it.forEach(e),this.h()},h(){S(m,"href","https://github.com/kmonad/kmonad"),S(m,"rel","nofollow"),S(c,"href","https://github.com/rvaiya/keyd"),S(c,"rel","nofollow")},m(t,a){n(t,y,a),o(y,K),n(t,T,a),n(t,b,a),o(b,z),n(t,_,a),n(t,k,a),o(k,q),n(t,W,a),n(t,w,a),o(w,O),n(t,x,a),n(t,g,a),o(g,L),n(t,E,a),n(t,p,a),o(p,R),o(p,m),o(m,X),o(p,Y),n(t,P,a),n(t,v,a),o(v,H),n(t,A,a),n(t,f,a),o(f,D),o(f,c),o(c,F),o(f,G),n(t,B,a),n(t,I,a),o(I,J),n(t,M,a),n(t,j,a),o(j,N)},p:U,i:U,o:U,d(t){t&&e(y),t&&e(T),t&&e(b),t&&e(_),t&&e(k),t&&e(W),t&&e(w),t&&e(x),t&&e(g),t&&e(E),t&&e(p),t&&e(P),t&&e(v),t&&e(A),t&&e(f),t&&e(B),t&&e(I),t&&e(M),t&&e(j)}}}const yt={slug:"cO6vGW",title:"Did I tell you about keyd?",description:"A quick share about keyd as a keyboard config management tool",date:"22 July 2024",tags:["engineering","linux","keyboard"]};class pt extends lt{constructor(y){super(),rt(this,y,null,ut,ht,{})}}export{pt as default,yt as metadata};
